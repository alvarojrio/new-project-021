...
$(document).ready(function() {
    ...
    /************************************
     ...
     # 
    *************************************/ 
    $(document).on('click', '.btn-modal-favoritos-diagnosticos', function(event) { 
    ...
    /************************************
     #
     # Aplicando função ao evento click do elemento .btn-modal-comentarios-doenca
     # 
    *************************************/ 
    $(document).on('click', '.btn-modal-comentarios-doenca', function(event) { 
    
        event.preventDefault();

        // Abre janela modal de comentarios
        $('#modal-comentarios-teste').modal('show');
