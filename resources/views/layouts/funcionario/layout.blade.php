    ...
    <div class="main_container">
        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                @include('layouts.funcionario.sidebar')
            </div>
        </div>
        <!-- FIM LEFT COL -->
        ...
        <!-- INICIO TOP NAV -->
        <div class="top_nav">   
            @include('layouts.funcionario.topo')
        </div>
        <!-- FIM TOP NAV -->
        
        <!-- INICIO RIGHT COL -->
        <div class="right_col" role="main" style="min-height: 545px;">
        ...
        <footer>
            <div class="text-center">
                @include('layouts.funcionario.rodape')
            </div>
...
$(document).ready(function() {
    ...
    // Ativação do icheck em checkboxes
    $('.checkbox').iCheck({
