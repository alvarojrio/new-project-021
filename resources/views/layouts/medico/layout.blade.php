...
<meta name="dcterms.rights" content="(c) {{ date('Y') }} Clínica Rio de Janeiro" /> 
...
<link media="all" type="text/css" rel="stylesheet" href="{{ asset('plugins/fontawesome-free-5.9.0/css/all.min.css') }}" />
...
<link media="all" type="text/css" rel="stylesheet" href="{{ asset('plugins/jquery-ui-1.12.1.custom/jquery-ui.theme.min.css') }}" />
...
<link type="text/css" rel="stylesheet" href="<?php echo asset('css/custom.min.css'); ?>" />

<!-- PERSONALIZADO QUE JÁ EXISTIA (REVER?!?) -->
<link type="text/css" rel="stylesheet" href="<?php echo asset('css/style.css'); ?>" />  

<!-- CORREÇÕES NO CSS DO MENU PADRÃO -->
<link type="text/css" rel="stylesheet" href="<?php echo asset('css/correcoes-menu-1.0.css'); ?>" />

<!-- CSS DO MENU DO PRONTUARIO -->
<link type="text/css" rel="stylesheet" href="<?php echo asset('css/menu-prontuario-1.0.css'); ?>" />   
...
<div class="container body">
    ...
    <div class="main_container">
        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                ...
                @if ($tipo_menu == 'prontuario')
                    ...
                    @include('layouts.medico.sidebar-com-menu-prontuario')

                @else

                    @include('layouts.medico.sidebar')
        ...
        <div class="top_nav">   
            ...
            @include('layouts.medico.topo')
            
        </div>
        <!-- FIM TOP NAV -->
        
        <!-- INICIO RIGHT COL -->
        <div class="right_col" role="main" style="min-height: 525px;">
