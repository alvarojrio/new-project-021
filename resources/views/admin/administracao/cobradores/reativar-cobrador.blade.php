...
CMRJ | Cobradores | Reativar
@stop

@section('conteudo')

{!! Breadcrumbs::render('cobradores-reativar') !!}

<div class="page-title">
  <div class="title_left">
    <h3>Reativar Cobrador </h3>
  </div>
</div>
    ...
    <div class="x_panel">
      <div class="x_content">
        <div class="row">
          ...
          <h2 class="text-danger">Este cobrador encontra-se inativo!</h2>
          <p>O campo MOTIVO deve conter no mínimo <span class="required-red">10 caracteres</span> ! </p>
          Caso deseje efetuar a <strong class="green"> ATIVAÇÃO </strong> deste COBRADOR informe um motivo e pressione o botão SIM. 
          <br />  
          
          <br /><br />  
          <hr/>
          
          <h2 class="text-info"><strong>Nome:</strong> <?php echo $cobrador->nome; ?>.</h2>
          <h4 class="text-info">
              <strong>CPF:</strong> 
              <span class="red">
                <?php    
          ...
          <form method="POST" action="<?php echo url('admin/painel/cobradores/reativar-cobrador'); ?>" enctype="multipart/form-data">
            ...
            <div class="col--4 col-xs-12">
              ...
              <div class="form-group">
               ...
               Deseja realmente <strong class="green"> REATIVAR </strong> este COBRADOR?
               ...
               <input type="hidden" id="codigo_funcionario" name="codigo_funcionario" value="{{$cobrador->cod_funcionario}}" />
