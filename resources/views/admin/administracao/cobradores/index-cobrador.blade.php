        ...
        <div class="x_panel">
            <div class="x_content">
                ...
                <div class="table-responsive">
                            ...
                            <?php foreach ($cobradores as $cobrador): ?>
                                <tr>
                                    ...
                                    <td class="text-center col-xs">
                                        ...
                                        <a class="btn btn-sm btn-default" data-tooltip="tooltip" title="Visualizar" href="{{ url('admin/painel/cobradores/visualizar-cobrador/'. Crypt::encrypt($cobrador->cod_funcionario)) }}">
                                    ...
                                    <td class="text-center col-xs">
                                        ...
                                        <a class="btn btn-sm btn-danger" data-tooltip="tooltip" title="Inativar" href="{{ url('admin/painel/cobradores/inativar-cobrador/'. Crypt::encrypt($cobrador->cod_funcionario)) }}')">
                    ...
                    <a class="btn btn-sm btn-danger" href="{{ url('admin/painel/cobradores/index-cobrador-inativo') }}">
