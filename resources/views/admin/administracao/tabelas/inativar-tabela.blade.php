...
CMRJ | Tabelas | Inativar
@stop

@section('conteudo')

<!-- Renderizo o Breadcrumb -->
{!! Breadcrumbs::render('tabelas-inativar') !!}

<div class="page-title">
  <div class="title_left">
    <h3>Inativar Tabela </h3>
  </div>
</div>
    ...
    <div class="x_panel">
      <div class="x_content">
        <div class="row">
          ...
          <h2 class="text-info"><strong>Nome da Tabela:</strong> <?php echo $tabela->nome_tabela; ?></h2>
       
          <hr/>

          Você está prestes a efetuar a INATIVAÇÃO desta tabela. Lembre-se de que automaticamente a mesma ficará INDISPONÍVEL a todos e a tudo o que está vinculado a ela. 

          <br /><br />

          
          
          <form method="POST" action="<?php echo url('admin/painel/tabelas/inativar-tabela'); ?>" enctype="multipart/form-data" id="form_salas">
            ...
            <div class="col--4 col-xs-12">
              ...
              <div class="form-group">
               ...
               Deseja realmente INATIVAR esta TABELA?
