...
{!! Breadcrumbs::render('tabelas-definir-valores-procedimentos-inativos', $tabela) !!}
            ...
            <div class="x_content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-xs-12" align="center">
                        ...
                        <a class="btn btn-md btn-info disabled botao_desativado" href="javascript:void(null);">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-xs-12" style="margin-top: 7px; margin-bottom: 7px;">
                        ...
                        <div class="box_alerta_amarelo">
                            ...
                            - Ao definir a data de vigência de um preço para a data de hoje, o procedimento terá automaticamente seu status alterado para <span class="text-success"><b>ativo</b></span>. <br />
                            - Caso programe uma futura data de inicio de vigência de um preço para uma data previamente já utilizada, o valor anterior será descartado.
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">  
                        ...
                        <h2>Lista de Procedimentos Inativos</h2>
...
$(document).ready(function() {
    ...
    var tabela = $('.minha_datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
            "url": "<?php echo url('admin/painel/tabelas/datatable-tabelas-procedimentos-inativos'); ?>",
            "type": "POST",
            "data": {
    ...
    $(document).on('click', '.btn_salvar', function() {
        ...
        if (tipo_cobranca == '') {
            ...
            $.ajax({
                cache: false,
                type: "POST",
                url: "<?php echo url('admin/painel/procedimentos/salvar-valores-procedimento'); ?>",
                data: { 
                    "cod_procedimento": cod_procedimento,
