...
{!! Breadcrumbs::render('tabelas-definir-valores-procedimentos-ativos', $tabela) !!}
            ...
            <div class="x_content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-xs-12" align="center">
                        ...
                        <a class="btn btn-md btn-primary disabled botao_desativado" href="javascript:void(null);">
...
$(document).ready(function() {
    ...
    var tabela = $('.minha_datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
            "url": "<?php echo url('admin/painel/tabelas/datatable-tabelas-procedimentos-ativos'); ?>",
            "type": "POST",
            "data": {
