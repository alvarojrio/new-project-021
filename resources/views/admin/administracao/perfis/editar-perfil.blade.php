...
{!! Breadcrumbs::render('perfis-alterar') !!}
	...
	<div class="col-xs-12">
		<div class="x_panel">
			<div class="x_content">
                ...
                <form method="POST" action="<?php echo url('admin/painel/perfis/editar-perfil'); ?>">
                ...
                <div class="row">  
                    ...
                    <div class="form-group col-sm-12 col-xs-12">
                        ...
                        <input type="text" class="form-control" name="nome" id="nome" autocomplete="off" value="<?php echo $perfil->display_name; ?>">
                ...
                <div class="row"> 
                    ...
                    <div class="form-group col-sm-12 col-xs-12">
                        ...
                        <textarea class="form-control" rows="2" id="descricao" name="descricao" minlength="5"><?php echo $perfil->description; ?></textarea>
				                    ...
				                    <div class="panel-body">
										...
										?>
                                            ...
                                            if (in_array($p->id, $permissoes_do_perfil)) {
                                                ...
                                                // Variavel usada para verificar se o checkbox deve ou não estar marcado
                                                $marcar = true;
											...
											<input class="form-check-input" type="checkbox" name="permissao[]" value="<?php echo $p->id; ?>" <?php if ($marcar) { ?>checked="checked"<?php } ?> />
                ...
                <input type="hidden" id="nome_atual" name="nome_atual" value="<?php echo $perfil->display_name; ?>" />
