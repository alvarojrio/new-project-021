...
{!! Breadcrumbs::render('pessoa-fisica-remover-membro-contrato', $contrato) !!}
    ...
    <div class="col-xs-12">
        <div class="x_panel">
            <div class="x_content">
                ...
                <form id="frm_remover_membro" method="post" action="<?php echo url(app('prefixo') . '/painel/contratos/pessoafisica/remover-membro'); ?>">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3 col-xs-12">
                                ...
                                <span class="letra-azul-claro"><?php echo $pessoa_fisica->clientes->pessoa->cpf; ?></span>
                            </div>

                            <div class="form-group col-md-3 col-xs-12">
                                <label class="control-label">Nome</label> <br />
                                <span class="letra-azul-claro"><?php echo $pessoa_fisica->clientes->pessoa->nome; ?></span>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12 col-xs-12">
                        ...
                        <input type="hidden" id="cod_membro" name="cod_membro" value="<?php echo $id_membro; ?>" /> 
                        
                        <!-- BOTÃO RETORNAR -->
                        <a class="btn btn-md btn-danger" id="btn_retornar" href="<?php echo url(app('prefixo') . '/painel/contratos/pessoafisica/gerenciar-membros/' . Crypt::encrypt($contrato->cod_contrato_pessoa_fisica_plano)); ?>">
