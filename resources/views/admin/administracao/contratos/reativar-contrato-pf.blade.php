...
{!! Breadcrumbs::render('pessoa-fisica-reativar-contrato', $contrato) !!}

<div class="page-title">
    <div class="title_left">
        <h3>Reativar Contrato Pessoa Física</h3>
    </div>
</div>
    ...
    <div class="col-xs-12">
        <div class="x_panel">
            <div class="x_content">
                ...
                <form id="frm_cancelar_contrato" method="post" action="<?php echo url(app('prefixo') . '/painel/contratos/pessoafisica/reativar'); ?>">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12 col-xs-12">
                        ...
                        <!-- BOTÃO RETORNAR -->
                        <a class="btn btn-md btn-danger" id="btn_retornar" href="<?php echo url(app('prefixo') . '/painel/contratos/pessoafisica/visualizar/' . Crypt::encrypt($contrato->cod_contrato_pessoa_fisica_plano)); ?>">
