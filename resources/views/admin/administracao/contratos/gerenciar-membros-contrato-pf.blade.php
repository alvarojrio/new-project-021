...
{!! Breadcrumbs::render('pessoa-fisica-gerenciar-membros-contrato', $contrato) !!}
        ...
        <div class="x_panel">
            <div class="x_content">
                                                    ...
                                                    <div class="x_panel tile" style="border-color: #73879C;">
                                                        ...
                                                        <div class="row" style="margin-top: 10px;">
                                                            <div class="col-md-6 col-xs-12">
                                                                <a class="btn btn-block btn-default btn_ver_membro" href="<?php echo url(app('prefixo') . '/painel/clientes/pessoafisica/visualizar/'. Crypt::encrypt($pessoa_fisica->clientes->cod_pessoa)); ?>">
                                                                    <i class="fa fa-search"></i> Ver
                                                                </a>
                                                            </div>
                                                            <div class="col-md-6 col-xs-12">
                                                                <a class="btn btn-block btn-danger btn_inativa_membro" href="<?php echo url(app('prefixo') . '/painel/contratos/pessoafisica/remover-membro/' . Crypt::encrypt($mem->cod_membro)); ?>">
                                ...
                                <div class="panel panel-info panel_cadastrar_pessoas">
                                    ...
                                    <div id="collapse2" class="panel-collapse collapse muda-collapse">
                                        <div class="panel-body">
                                            ...
                                            @render(drclub\Http\ViewComponents\CadastrarPessoaFisicaComponent::class, 'gerenciarmembros')
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            ...
                                            <tr class="m_<?php echo $memi->pivot->cod_membro; ?> <?php if ($memi->pivot->vinculo == 3 || $memi->pivot->vinculo == 2) { ?>success<?php } ?>">
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-default" href="<?php echo url(app('prefixo') . '/painel/clientes/pessoafisica/visualizar/'. Crypt::encrypt($pessoa_fisica->clientes->cod_pessoa)); ?>">
                ...
                <div style="width: 180px; margin: 0 auto;">
                    ...
                    <!-- BOTÃO RETORNAR -->
                    <a class="btn btn-md btn-default" id="btn_retornar" href="<?php echo url(app('prefixo') . '/painel/contratos/pessoafisica/visualizar/' . Crypt::encrypt($contrato->cod_contrato_pessoa_fisica_plano)); ?>">
...
<!-- *********************************************
 ...
 # 
************************************************** -->
<div class="modal fade modal_confirma_adicao_membro" id="modalConfirmaAdicaoMembro" role="dialog">
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <select class="form-control input-sm" name="membro_antigo_modal" id="membro_antigo_modal">
                            ...
                            <option value="<?php echo $pessoa_fisica->clientes->pessoa->cod_pessoa; ?>"><?php echo $pessoa_fisica->clientes->pessoa->nome; ?></option>
...
$(document).ready(function() {
    ...
    *************************************/ 
    $(document).on('click', '.btn_confirmar_inclusao', function(e) {
        ...
        // Checo se foi marcado um vinculo
        if (vinculo_modal == '') {
        ...
        $.ajax({
            ...
            success: function(responseR) {
                ...
                if (responseR.status == 'erro') {
                    ...
                    conteudo_caixa_membro += '</div>';
                    conteudo_caixa_membro += '<div class="col-md-6 col-xs-12">';
                    conteudo_caixa_membro += '<a class="btn btn-block btn-danger btn_inativa_membro" href="<?php echo url(app('prefixo') . '/painel/contratos/pessoafisica/remover-membro'); ?>/' + responseR.cod_membro_crypt + '">';
    ...
    *************************************/ 
    $(document).on('click', '.btn_confirmar_trade', function(e) {
        ...
        var vinculo_modal = $(this).closest('#modalConfirmaTradeMembro').find('#vinculo_modal option:selected').val();
        var servicos_selecionados_modal = new Array; // Crio um array
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo url(app('prefixo') . '/painel/contratos/pessoafisica/substituir-membro-ajax'); ?>",
            data: { 
                "cod_contrato_pessoa_fisica_plano": '<?php echo Crypt::encrypt($contrato->cod_contrato_pessoa_fisica_plano); ?>',
    ...
    ***************************************************************************************/ 
    $(document).on('click', '.btn_atualizar_membros', function(e) {
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo url(app('prefixo') . '/painel/contratos/pessoafisica/alterar-membros-ajax'); ?>",
            data: { 
