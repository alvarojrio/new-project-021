            ...
            <div class="x_content">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <h2 class="text-info"><strong>Empresa:</strong> {{$pessoa_juridica->nome_fantasia}}</h2>
                    ...
                    <div class="col-xs-12">
                        ...
                        <label class="control-label alert alert-info col-xs-12">Está empresa já tem cadastro, caso deseja incluir ela também como um favorecido (fornecedor) escolha a categoria financeira abaixo. </label>
                        
                    </div>

                    <form method="POST" action="<?php echo url('admin/painel/favorecidos/incluir-favorecido-pessoa-juridica'); ?>" enctype="multipart/form-data" id="form_salas">
                        ...
                        <div class="col-lg-6 col-xs-12">
                            ...
                            Deseja realmente incluir está empresa como favorecido (fornecedor)?
                            ...
                            <input type="hidden" id="cod_pessoa_juridica" name="cod_pessoa_juridica" value="{{ Crypt::encrypt($pessoa_juridica->cod_pessoa_juridica) }}" />
