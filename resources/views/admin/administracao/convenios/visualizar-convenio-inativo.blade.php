...
CMRJ | Convênios | Visualizar Inativo
@stop
...
{!! Breadcrumbs::render('convenios-inativo-visualizar') !!}
                            ...
                            <tbody>
                                <tr>
                                    <td class="text-center" colspan="2">
                                        <img src="<?php
                                        if ($convenio->logotipo == "") {
                                            $foto = "sem_foto.png";
                                        } else {
                                            $foto = $convenio->logotipo;
                                        } echo asset('uploads/convenios/logotipos/' . $foto)
                                        ?>" alt="Imagem" width="200px" height="200px" accesskey="" class="img-thumbnail">
                                    </td>                                    
                                </tr>
                                <tr>
...
<?php } ?>
                                                ...
                                                <td class="text-center col-xs">
                                                    ...
                                                    <a class="btn btn-sm btn-default" data-tooltip="tooltip" title="Visualizar" href="#">
                                                ...
                                                <td class="text-center col-xs">
                                                    ...
                                                    <a class="btn btn-sm btn-primary" data-tooltip="tooltip" title="Vínculos" href="#">
                                                ...
                                                <td class="text-center col-xs">
                                                    ...
                                                    <a class="btn btn-sm btn-primary" data-tooltip="tooltip" title="Clonar" href="#">
                                                ...
                                                <td class="text-center col-xs">
                                                    ...
                                                    <a class="btn btn-sm btn-primary" data-tooltip="tooltip" title="Migrar Pacientes" href="#">
