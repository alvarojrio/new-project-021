...
{!! Breadcrumbs::render('convenios-inativar') !!}

<div class="page-title">
  <div class="title_left">
    <h3>Inativar Convênio </h3>
  </div>
</div>
    ...
    <div class="x_panel">
      <div class="x_content">
        <div class="row">
          ...
          <h2 class="text-info"><strong>Nome do Convênio:</strong> <?php echo $convenio->nome_convenio; ?></h2>
       
          <hr/>

          Você está prestes a efetuar a INATIVAÇÃO deste convênio. Lembre-se de que automaticamente a mesma ficará INDISPONÍVEL a todos e a tudo o que está vinculado a ele. 

          <br /><br />

          
          
          <form method="POST" action="<?php echo url('admin/painel/convenios/inativar-convenio'); ?>" enctype="multipart/form-data" id="form_salas">
            ...
            <div class="col--4 col-xs-12">
              ...
              <div class="form-group">
               ...
               Deseja realmente INATIVAR este CONVÊNIO?
