      ...
      <div class="panel panel-info">
        <div class="panel-heading">
          <h3 class="text-center">
            <i class="fa fa-info-circle" aria-hidden="true"></i> Consulte a lista de convênios:<br/>
            <small>Ainda não há registros de - <b> convênios inativos no sistema.</b></small>
          </h3>
        </div>
        <div class="panel-body">
         <h2 class="text-danger">Atenção!</h2> 
          ...
          <button id="enviar" type="submit" tabindex="1" class="btn btn-primary" onclick="javascript: window.location.replace('<?php echo URL::to('admin/painel/convenios/'); ?>');">
            <i class="fa fa-undo" aria-hidden="true"></i> Listar Convênios Ativos
          </button>
