...
<div class="page-title">
  <div class="title_left">
    <h3>Reativar Plano Auto Gestão </h3>
  </div>
</div>
    ...
    <div class="x_panel">
      <div class="x_content">
        <div class="row">
          ...
          Caso deseje efetuar a <strong class="green"> ATIVAÇÃO </strong> deste PLANO AUTO GESTÃO informe um motivo e pressione o botão SIM. 
          <br />  
          ...
          <hr/>
            Você está prestes a efetuar a REATIVAÇÃO deste PLANO Auto Gestão.
          <br /><br />
          
          <form method="POST" action="<?php echo url('admin/painel/planos/reativar-plano-auto-gestao'); ?>" enctype="multipart/form-data">
            ...
            <div class="col--4 col-xs-12">
              ...
              <div class="form-group">
               ...
               Deseja realmente REATIVAR este PLANO AUTO GESTÃO ?
