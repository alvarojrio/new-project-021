...
<link media="all" type="text/css" rel="stylesheet" href="<?php echo asset('css/admin/administracao/planos/planos-cadastrar.css'); ?>">
                                                ...
                                                <div class="panel-body">
                                                        ...
                                                        <div class="col-md-2 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="faturado" id="faturado">
                                                                    <option value="0" <?php if (old('faturado') === "0" || old('faturado') == NULL) { echo "selected";} ?>>Não</option>
                                                                    <option value="1" <?php if (old('faturado') === "1") { echo "selected"; } ?>>Sim</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-2 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control datepicker" name="data_inicio" id="data_inicio" placeholder="Data inicial" value="{{ old('data_inicio') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-4 col-xs-12">
                                                            ...
                                                            <div class="form-inline">
                                                                <input type="text" name="valor_plano_individual" id="valor_plano_individual" class="form-control pull-left money" placeholder="Valor Individual" size="14">
                                                                <input type="text" name="valor_plano_grupo" id="valor_plano_grupo" class="form-control pull-right money" placeholder="Valor Grupo" size="14" >
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4 col-xs-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4 col-xs-12">
                                                            ...
                                                            <div class="form-inline">
                                                                <input type="text" name="valor_inclusao_dependente_individual" id="valor_inclusao_dependente_individual" class="form-control pull-left money" placeholder="Valor Individual" size="14">
                                                                <input type="text" name="valor_inclusao_dependente_grupo" id="valor_inclusao_dependente_grupo" class="form-control pull-right money" placeholder="Valor Grupo" size="14" >
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4 col-xs-12">
                                                            <label class="control-label">Valor carteirinha <span class="required-red">*</span></label>
                                                            <div class="form-inline">
                                                                <input type="text" name="valor_carteirinha_individual" id="valor_carteirinha_individual" class="form-control pull-left money" placeholder="Valor Individual" size="14">
                                                                <input type="text" name="valor_carteirinha_grupo" id="valor_carteirinha_grupo" class="form-control pull-right money" placeholder="Valor Grupo" size="14" >
                                                            </div>
                                                        </div>
                                                    </div>        
                                        ...
                                        <div class="col-xs-12"> 
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="col-md-12 col-xs-12" id="aviso_carencia">
                                                        <ul class="list-group">
                                                            <li class="list-group-item d-flex justify-content-between align-items-center list-group-item-info">
                                                                Para habilitar, selecione uma tabela na aba dados cadastrais.
                                                            </li>
                                                        </ul>                        
                                                    </div> 
                                    ...
                                    <div class="card pf" id="modelo_carteirinha_pessoa_fisica">
                                        ...
                                        <div class="caixa-modelo">
                                            ...
                                            <div class="caixa-opcao">
                                                Modelo 1  <input type="radio" class="form-group card" name="card" id="card" value="1"/>
                                            </div>
                                        ...
                                        <div class="caixa-modelo">
                                            <div class="caixa-opcao">
                                                Modelo 2 <input type="radio" class="form-group card" name="card" id="card" value="2"/>
                                            </div>
                                            <div class="card2">
                                        ...
                                        <div class="caixa-modelo">
                                            ...
                                            <div class="caixa-opcao">
                                                Modelo 3 <input type="radio" class="form-group card" name="card" id="card" value="3"/>
                                            </div>
...
$(document).ready(function () {
    ...
    ******************************************************/
    ...
    $('#salvar').on('click', function (e) {
        ...
        var cancelar_se_inadimplente = $('#cancelar_se_inadimplente').val();
        var data_inicio = $('#data_inicio').val();
        var valor_plano_individual = $('#valor_plano_individual').val();
        var valor_plano_grupo = $('#valor_plano_grupo').val();
        var valor_inclusao_dependente_individual = $('#valor_inclusao_dependente_individual').val();
        var valor_inclusao_dependente_grupo = $('#valor_inclusao_dependente_grupo').val();
        var valor_carteirinha_individual = $('#valor_carteirinha_individual').val();
        var valor_carteirinha_grupo = $('#valor_carteirinha_grupo').val();
        ...
        $.ajax({
            ...
            data: {
                ...
                "codigo": codigo,
                "cancelar_se_inadimplente": cancelar_se_inadimplente,
                "data_inicio": data_inicio,
                "valor_plano_individual": valor_plano_individual,
                "valor_plano_grupo": valor_plano_grupo,
                "valor_inclusao_dependente_individual": valor_inclusao_dependente_individual,
                "valor_inclusao_dependente_grupo": valor_inclusao_dependente_grupo,
                "valor_carteirinha_individual": valor_carteirinha_individual,
                "valor_carteirinha_grupo": valor_carteirinha_grupo,
...
$('#valor_inclusao_dependente_individual').maskMoney();
$('#valor_inclusao_dependente_grupo').maskMoney();
$('#valor_carteirinha_individual').maskMoney();
$('#valor_carteirinha_grupo').maskMoney();
