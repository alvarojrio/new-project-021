    ...
    <div class="x_panel">
      <div class="x_content">
        <div class="row">
          ...
          <hr/>
          Você está prestes a efetuar a INATIVAÇÃO deste PLANO ANS. Lembre-se de que automaticamente o mesmo ficará INDISPONÍVEL a todos e a tudo o que está vinculado. 
          <br /><br />
          
          <form method="POST" action="<?php echo url('admin/painel/planos/inativar-plano-ans'); ?>" enctype="multipart/form-data">
            ...
            <div class="col--4 col-xs-12">
              ...
              <div class="form-group">
               ...
               Deseja realmente INATIVAR este PLANO ANS?
