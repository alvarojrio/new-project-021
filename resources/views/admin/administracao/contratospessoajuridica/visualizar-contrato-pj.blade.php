...
{!! Breadcrumbs::render('pessoa-juridica-contrato-visualizar') !!}

<div class="page-title">
    <div class="title_left">
        <h3>Visualizar Contrato Pessoa Jurídica</h3>
    </div>
</div>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="tab-content tab_content_customizado">
                            ...
                            <div id="aba_1" class="tab-pane fade in active">
                                ...
                                <!-- ##################### INICIO CAIXA RESPONSÁVEL FINANCEIRO DO CONTRATO ###################### -->
                                <div class="panel panel-default">
                                    <div class="panel-heading clearfix">RESPONSÁVEL FINANCEIRO DO CONTRATO</div>
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4 col-xs-12">
                                                ...
                                                <span class="letra-azul-claro">
                                                    <?php 
                                                    if (!empty($contrato->pessoa_juridica->cnpj)) {

                                                        // Exibe valor com máscara já adicionada
                                                        echo drclub\Biblioteca\FuncoesGlobais::mascaraCnpj($contrato->pessoa_juridica->cnpj);
                                            ...
                                            <div class="form-group col-md-4 col-xs-12">
                                                ...
                                                <label class="control-label">Nome Fantasia</label> <br />
                                                <span class="letra-azul-claro"><?php echo $contrato->pessoa_juridica->nome_fantasia; ?></span>
                                        ...
                                        <div class="pull-right">
                                            ...
                                            <!-- BOTÃO EDITAR -->
                                            <a class="btn btn-block btn-default" id="btn_ver_pj" href="<?php echo url(app('prefixo') . '/painel/clientes/pessoajuridica/visualizar/' . Crypt::encrypt($contrato->pessoa_juridica->cod_pessoa_juridica)); ?>">
                                                <i class="fa fa-search"></i> Visualizar Perfil da Empresa
                                            </a>    
                                ...
                                <!-- ##################### FIM CAIXA RESPONSÁVEL FINANCEIRO DO CONTRATO ######################## -->
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3 col-xs-12">
                                                ...
                                                <label class="control-label">Cobrança da taxa de consulta</label> <br />
                                                <span class="letra-azul-claro">
                                                    <?php 
                                                    switch ($contrato->configuracao_taxa_consulta) {
                                                        case 0:
                                                            echo 'A empresa não irá cobrir';
                                                        break;

                                                        case 1:
                                                            echo 'A empresa irá cobrir';
                                                        break;
                                            ...
                                            <!--<div class="form-group col-md-3 col-xs-12">
                                                ...
                                                <label class="control-label">Usar Limite Contratado ?</label> <br />
                                                <span class="letra-azul-claro"><?php //echo ($contrato->configuracao_taxa_consulta == 1) ? 'Sim' : 'Não'; ?></span>

                                            </div>  

                                            <div class="form-group col-md-3 col-xs-12">
                                                
                                                <label class="control-label">Qtd Limite Contratado</label> <br />
                                                <span class="letra-azul-claro"><?php //echo $contrato->qtd_limite_contratado; ?></span>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                foreach ($membros_ativos as $mem) :
                                                    ...
                                                    // Busco perfil de Cliente relacionado ao Membro
                                                    $clientes = drclub\models\Clientes::where('cod_cliente', '=', $mem->cod_cliente)->first();
                                                ?>

                                                    <tr>
                                                        <td><?php echo (!empty($mem->numero_contrato_membro)) ? $mem->numero_contrato_membro : '-'; ?></td>
                                                        <td><?php echo (!empty($clientes->pessoa->cpf)) ? drclub\Biblioteca\FuncoesGlobais::mascaraCpf($clientes->pessoa->cpf) : '-'; ?></td>
                                                        <td><?php echo mb_strtoupper($clientes->pessoa->nome); ?></td>
                                                        <td>
                                                            <?php 
                                                        ...
                                                        <td>
                                                            <a class="btn btn-sm btn-default" data-tooltip="tooltip" title="Visualizar Perfil do Membro" href="<?php echo url(app('prefixo') . '/painel/clientes/pessoafisica/visualizar/'. Crypt::encrypt($clientes->cod_pessoa)); ?>">
                                                        ...
                                                        <?php
                                                        // Busco submembros relacionados ao membro atual do loop
                                                        $submembros_ativos = DB::table('pessoa_juridica_clientes')
                                                                               ->where('cod_contrato_pessoa_juridica_plano', '=', $contrato->cod_contrato_pessoa_juridica_plano)
                                                                               ->whereIn('status', array(1,2,3))
                                                                               ->where('vinculo', '=', 2)
                                                                               ->where('vinculado_a', '=', $clientes->cod_cliente)
                                                                               ->orderBy( DB::raw('LENGTH(numero_contrato_membro)'), 'ASC' ) // ordenação extra para garantir que a ordenação por número vai ficar correta
                                                                               ->orderBy('numero_contrato_membro', 'ASC')
                                                                               ->get();
                                                        ?>

                                                        <?php 
                                                        // Checo se existem submembros (dependentes) ativos para exibir
                                                        if (count($submembros_ativos) > 0) { 
                                                        ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <div class="form-group col-md-10 col-xs-12">
                                                                    ...
                                                                    <h4>Dependentes de <i><?php echo $clientes->pessoa->nome; ?></i></h4>
                                                                    ...
                                                                    <?php
                                                                    // Faço loop pelos membros
                                                                    foreach ($submembros_ativos as $submem) :

                                                                        // Busco perfil de Cliente relacionado ao Membro
                                                                        $subclientes = drclub\models\Clientes::where('cod_cliente', '=', $submem->cod_cliente)->first();
                                                                    ?>

                                                                        <tr class="warning">
                                                                            <td><?php echo (!empty($submem->numero_contrato_membro)) ? $submem->numero_contrato_membro : '-'; ?></td>
                                                                            <td><?php echo (!empty($subclientes->pessoa->cpf)) ? drclub\Biblioteca\FuncoesGlobais::mascaraCpf($subclientes->pessoa->cpf) : '-'; ?></td>
                                                                            <td><?php echo mb_strtoupper($subclientes->pessoa->nome); ?></td>
                                                                            <td>
                                                                                <?php 
                                                                                if (!empty($submem->data_inicio)) {
                                                                                    echo date('d/m/Y', strtotime($submem->data_inicio)); 
                                                                                } else {
                                                                                    echo '-';
                                                                                }
                                                                                ?>   
                                                                            ...
                                                                            <td>
                                                                                <a class="btn btn-sm btn-default" data-tooltip="tooltip" title="Visualizar Perfil do Membro" href="<?php echo url(app('prefixo') . '/painel/clientes/pessoafisica/visualizar/'. Crypt::encrypt($subclientes->cod_pessoa)); ?>">
                                                                                    <i class="fas fa-search"></i>
                                                                                </a>
                                                                            </td>
                                                                        </tr> 
                                ...
                                <div class="row" style="margin-top: 30px;">
                                    ...
                                    <?php if ($contrato->status == 0) { ?>
                                        ...
                                        <div class="col-md-4 col-xs-12">
                                            ...
                                            <!-- BOTÃO EDITAR -->
                                            <a class="btn btn-block btn-info" id="btn_editar" style="cursor: not-allowed !important;" href="javascript:void(null);">
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <div class="col-md-4 col-xs-12">
                                            ...
                                            <!-- BOTÃO EDITAR -->
                                            <a class="btn btn-block btn-info" id="btn_editar" href="<?php echo url(app('prefixo') . '/painel/contratos/pessoajuridica/editar/' . Crypt::encrypt($contrato->cod_contrato_pessoa_juridica_plano)); ?>">
                                                <i class="fa fa-edit"></i> Editar Contrato
                                            </a>    
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <div class="col-md-4 col-xs-12">
                                            ...
                                            <!-- BOTÃO GERENCIAR MEMBROS -->
                                            <a class="btn btn-block btn-dark" id="btn_gerenciar_membros" href="<?php echo url(app('prefixo') . '/painel/contratos/pessoajuridica/gerenciar-membros/' . Crypt::encrypt($contrato->cod_contrato_pessoa_juridica_plano)); ?>">
                                                <i class="fa fa-users"></i> Gerenciar Membros
                                            </a>    
                                    ...
                                    <?php if ($contrato->status == 0) { ?>
                                        ...
                                        <div class="col-md-4 col-xs-12">
                                            ...
                                            <a class="btn btn-block btn-success" id="btn_reativar_contrato" href="<?php echo url(app('prefixo') . '/painel/contratos/pessoajuridica/reativar/' . Crypt::encrypt($contrato->cod_contrato_pessoa_juridica_plano)); ?>">
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <div class="col-md-4 col-xs-12">
                                            ...
                                            <a class="btn btn-block btn-danger" id="btn_cancelar_contrato" href="<?php echo url(app('prefixo') . '/painel/contratos/pessoajuridica/cancelar/' . Crypt::encrypt($contrato->cod_contrato_pessoa_juridica_plano)); ?>">
...
var UrlBuscarMensalidadesContrato = '<?php echo url(app('prefixo') . '/painel/contratos/pessoajuridica/buscar-mensalidades'); ?>';
</script>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.btn_buscar_lt', function(event) {
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo url(app('prefixo') . '/painel/contratos/pessoajuridica/buscar-linha-tempo'); ?>",
            data: { 
    ...
    $(document).on('click', '.btn_resetar_lt', function(event) {
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo url(app('prefixo') . '/painel/contratos/pessoajuridica/resetar-linha-tempo'); ?>",
            data: { 
                "cod_contrato_pessoa_juridica_plano": "<?php echo Crypt::encrypt($contrato->cod_contrato_pessoa_juridica_plano); ?>"
            },
            beforeSend: function() {
    ...
    *************************************/
    $(document).on('click', '#tab_4', function(e) {
        ...
        $.ajax({
            ...
            data: { 
                "cod_contrato_pessoa_juridica_plano": <?php echo $contrato->cod_contrato_pessoa_juridica_plano; ?>
            },
            beforeSend: function() { 
