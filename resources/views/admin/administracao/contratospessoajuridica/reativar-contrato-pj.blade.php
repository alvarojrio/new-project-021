...
{!! Breadcrumbs::render('pessoa-juridica-reativar-contrato', $contrato) !!}

<div class="page-title">
    <div class="title_left">
        <h3>Reativar Contrato Pessoa Jurídica</h3>
    </div>
</div>
    ...
    <div class="col-xs-12">
        <div class="x_panel">
            <div class="x_content">
                ...
                <form id="frm_cancelar_contrato" method="post" action="<?php echo url(app('prefixo') . '/painel/contratos/pessoajuridica/reativar'); ?>">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12 col-xs-12">
                        ...
                        <input type="hidden" id="cod_contrato_pessoa_juridica_plano" name="cod_contrato_pessoa_juridica_plano" value="<?php echo Crypt::encrypt($contrato->cod_contrato_pessoa_juridica_plano); ?>" /> 
                        
                        <!-- BOTÃO RETORNAR -->
                        <a class="btn btn-md btn-danger" id="btn_retornar" href="<?php echo url(app('prefixo') . '/painel/contratos/pessoajuridica/visualizar/' . Crypt::encrypt($contrato->cod_contrato_pessoa_juridica_plano)); ?>">
