...
CMRJ | Contratos | Gerenciar Membros
@stop
...
{!! Breadcrumbs::render('pessoa-juridica-gerenciar-membros-contrato', $contrato) !!}
        ...
        <div class="x_panel">
            <div class="x_content">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3 col-xs-12">
                                ...
                                if ($contrato->status == 1) {
                                    ...
                                    echo '<span class="label label-warning" style="font-size: 12px;">';
                            ...
                            <div class="form-group col-md-3 col-xs-12">
                                <label class="control-label">Responsável Financeiro</label> <br />
                                <span class="letra-azul-claro"><?php echo $contrato->pessoa_juridica->razao_social; ?></span>
                            </div>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="tab-content tab_content_customizado">
                            ...
                            <div id="aba_1" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-xs-12" style="margin-top: 7px; margin-bottom: 7px;">
                                        ...
                                        <div class="box_alerta_amarelo">
                                            ...
                                            - Ao remover <b>membros</b>, os <b>submembros</b> relacionados também serão removidos.
                                    ...
                                    <div id="espaco_caixa_membros" style="margin-top: 10px;">
                                        ...
                                        <div class="row row_espaco_caixa_membros">
                                            ...
                                            foreach ($membros_ativos as $mem) :
                                                ...
                                                // Busco dados do Cliente relacionada ao Membro
                                                $cliente = drclub\models\Clientes::where('cod_cliente', '=', $mem->cod_cliente)->first();
                                                ...
                                                $servicos_selecionados = DB::table('pessoa_juridica_servicos_pessoa_juridica')
                                                                           ->where('status', '=', 1)
                                                                           ->where('cod_cliente', '=', $cliente->cod_cliente)
                                                                           ->where('cod_contrato_pessoa_juridica_plano', '=', $contrato->cod_contrato_pessoa_juridica_plano)
                                                                           ->pluck('cod_servico_pessoa_juridica');
                                            ...
                                            ?>
                                                ...
                                                <div class="col-md-4 col-sm-4 col-xs-12 caixa_membro" data-codigo-pessoa="<?php echo $cliente->cod_pessoa; ?>">

                                                    <input type="hidden" id="cod_membro" name="cod_membro" class="codigo_membro" value="<?php echo Crypt::encrypt($mem->cod_pjc); ?>" />
                                                    <input type="hidden" id="cod_cliente" name="cod_cliente" class="codigo_cliente" value="<?php echo Crypt::encrypt($cliente->cod_cliente); ?>" />
                                                    ...
                                                    <div class="x_panel tile" style="border-color: #73879C;">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8 col-xs-12"><span class="letra-azul-claro"><?php echo (!empty($cliente->pessoa->cpf)) ? $cliente->pessoa->cpf : '-'; ?></span></div>
                                                        </div>
                                                        <div class="row">
                                                            <label class="control-label col-md-4 col-xs-12">Nome: </label>
                                                            <div class="col-md-8 col-xs-12"><span class="letra-azul-claro membro_nome"><?php echo $cliente->pessoa->nome; ?></span></div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8 col-xs-12">
                                                                <span class="letra-azul-claro">
                                                                    <?php
                                                                    if ($cliente->pessoa->sexo == 1) { 
                                                                        echo 'Masculino';
                                                                    } elseif ($cliente->pessoa->sexo == 2) {
                                                                        echo 'Feminino';
                                                                    } else {
                                                                        echo '-';
                                                                    }
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8 col-xs-12">
                                                                <span class="letra-azul-claro">
                                                                    <?php echo (!empty($cliente->pessoa->data_nascimento)) ? date('d/m/Y', strtotime($cliente->pessoa->data_nascimento)) : '-'; ?>   
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <br />
                                                        <div class="row">
                                                            <div class="form-group">
                                                                <label class="control-label col-md-4 col-xs-12">Submembros: </label>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-12 col-xs-12">
                                                                <?php
                                                                // Seleciono SUBMEMBROS relacionados ao MEMBRO atual do loop
                                                                $submembros_relacionados = DB::table('pessoa_juridica_clientes')
                                                                                             ->join('clientes', 'clientes.cod_cliente', '=', 'pessoa_juridica_clientes.cod_cliente')
                                                                                             ->join('pessoa', 'pessoa.cod_pessoa', '=', 'clientes.cod_pessoa')
                                                                                             ->where('pessoa_juridica_clientes.vinculado_a', '=', $cliente->cod_cliente)
                                                                                             ->whereIn('pessoa_juridica_clientes.status', array(1,2,3))
                                                                                             ->select('pessoa.cod_pessoa', 'pessoa.nome')
                                                                                             ->get();
                                                                ?>

                                                                <select class="form-control pessoas_submembro" name="submembros[]" id="submembros<?php echo $counter; ?>" multiple>
                                                                <?php if (count($submembros_relacionados) > 0) { ?>
                                                                    <?php
                                                                    foreach ($submembros_relacionados as $subr) :
                                                                    ?>
                                                                        <option value="<?php echo $subr->cod_pessoa; ?>" selected="selected"><?php echo $subr->nome; ?></option>
                                                                    <?php
                                                                    endforeach;
                                                                    ?>
                                                                <?php } ?>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12 col-xs-12">
                                                                ...
                                                                <?php
                                                                // Faço loop por $servicos_pessoa_juridica
                                                                foreach ($servicos_pessoa_juridica as $spj) :
                                                                ?>
                                                                <input class="form-check-input" type="checkbox" name="servicos_membro[]" id="servicos_membro" value="<?php echo $spj['cod_servico_pessoa_juridica']; ?>" <?php if (in_array($spj['cod_servico_pessoa_juridica'], $servicos_selecionados)) { ?>checked="checked"<?php } ?> />
                                                                <span class="letra-azul-claro"><?php echo $spj['nome_servico']; ?></span> <br />
                                                                <?php
                                                                endforeach;
                                                                ?>
                                                        ...
                                                        <div class="row" style="margin-top: 10px;">
                                                            <div class="col-md-6 col-xs-12">
                                                                <a class="btn btn-block btn-default btn_ver_membro" href="<?php echo url(app('prefixo') . '/painel/clientes/pessoafisica/visualizar/'. Crypt::encrypt($cliente->cod_pessoa)); ?>">
                                                                    <i class="fa fa-search"></i> Ver
                                                                </a>
                                                            </div>
                                                            <div class="col-md-6 col-xs-12">
                                                                <a class="btn btn-block btn-danger btn_inativa_membro" href="<?php echo url(app('prefixo') . '/painel/contratos/pessoajuridica/remover-membro/' . Crypt::encrypt($mem->cod_pjc)); ?>">
                                ...
                                <h2>Adicionando / Substituindo Membros</h2>
                                ...
                                <div class="panel panel-info panel_cadastrar_pessoas">
                                    ...
                                    <div id="collapse2" class="panel-collapse collapse muda-collapse">
                                        <div class="panel-body">
                                            ...
                                            @render(drclub\Http\ViewComponents\CadastrarPessoaFisicaComponent::class, 'gerenciarmembrospj')
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        foreach ($membros_inativos as $memi) :
                                            ...
                                            // Busco dados do Cliente relacionada ao Membro
                                            $cliente = drclub\models\Clientes::where('cod_cliente', '=', $memi->cod_cliente)->first();
                                        ?>
                                            ...
                                            <tr class="m_<?php echo $memi->pivot->cod_membro; ?> <?php if ($memi->pivot->vinculo == 3 || $memi->pivot->vinculo == 2) { ?>success<?php } ?>">
                                                ...
                                                <td><?php echo (!empty($cliente->pessoa->cpf)) ? $cliente->pessoa->cpf : '-'; ?></td>
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-default" href="<?php echo url(app('prefixo') . '/painel/clientes/pessoafisica/visualizar/'. Crypt::encrypt($cliente->cod_pessoa)); ?>">
                ...
                <div style="width: 180px; margin: 0 auto;">
                    ...
                    <!-- BOTÃO RETORNAR -->
                    <a class="btn btn-md btn-default" id="btn_retornar" href="<?php echo url(app('prefixo') . '/painel/contratos/pessoajuridica/visualizar/' . Crypt::encrypt($contrato->cod_contrato_pessoa_juridica_plano)); ?>">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        ...
                        foreach ($servicos_pessoa_juridica as $spj) :
                        ?>
                        <input class="form-check-input" type="checkbox" name="servicos_membro_modal[]" id="servicos_membro_modal" value="<?php echo $spj['cod_servico_pessoa_juridica']; ?>" />
                        <span class="letra-azul-claro"><?php echo $spj['nome_servico']; ?></span> <br />
                        <?php
                        endforeach;
                        ?>
...
<!-- *********************************************
 #
 # INICIO MODAL CONFIRMAÇÃO DE SUBSTITUIÇÃO DE MEMBRO
 # 
************************************************** -->
<div class="modal fade modal_confirma_trade_membro" id="modalConfirmaTradeMembro" role="dialog">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
      
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h2 class="modal-title">Confirmar Substituição de Membro</h2>
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <b style="color: #555555;">MEMBRO QUE SERÁ SUBSTITUÍDO</b>
                    </div>
                </div>

                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <select class="form-control input-sm" name="membro_antigo_modal" id="membro_antigo_modal">
                            ...
                            <option value="<?php echo $cliente->pessoa->cod_pessoa; ?>"><?php echo $cliente->pessoa->nome; ?></option>
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <b style="color: #555555;">NOVO MEMBRO</b>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" id="cod_pessoa_modal_2" name="cod_pessoa_modal_2" />

                <a href="javascript:void(null);" class="btn btn-md btn-danger btn_cancelar_trade" data-dismiss="modal" aria-label="Close">Cancelar</a>
                <a href="javascript:void(null);" class="btn btn-md btn-success btn_confirmar_trade">Confirmar substituição</a>
...
<!-- *****************************************
 #
 # FIM MODAL CONFIRMAÇÃO DE SUBSTITUIÇÃO DE MEMBRO
 # 
********************************************** -->
...
var servicos_possiveis = '<?php echo json_encode($servicos_pessoa_juridica); ?>';
...
var contrato_sendo_gerenciado = '<?php echo \Crypt::encrypt($contrato->cod_contrato_pessoa_juridica_plano); ?>';
</script>

<script type="text/javascript">
/* CONFIGURA O JAVASCRIPT DO SELECT MULTIPLE PARA CADA CAIXA DE MEMBRO */
...
window['combo_submembro<?php echo $counter; ?>'] = $('#submembros<?php echo $counter; ?>');

// Ativa o select multiple (com busca ajax)
window['combo_submembro<?php echo $counter; ?>'].select2({
    language: "pt-BR",
...
$(document).ready(function() {
    ...
    *************************************/ 
    $(document).on('click', '.btn_buscar_pf', function(event) {
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo url(app('prefixo') . '/painel/clientes/pessoafisica/buscar-para-contrato2'); ?>",
            data: { 
                "cpf_busca": cpf_busca,
                ...
                if (response.status == 'erro') {
                    ...
                    tabela_pf = $('.minha_datatable_pf').DataTable({
                        ...
                        columns: [
                            ...
                            { "data": "btn_trade_membro", "name": "btn_trade_membro", "width": "2%", "searchable": false, "sortable": false }
                        ],
    ...
    *************************************/ 
        ...
        $.ajax({
            ...
            success: function(responseR) {
                ...
                if (responseR.status == 'erro') {
                    ...
                    conteudo_caixa_membro += '<select class="form-control pessoas_submembro" name="submembros[]" id="submembros" multiple>';
                    ...
                    conteudo_caixa_membro += '<a class="btn btn-block btn-default btn_ver_membro" href="<?php echo url(app('prefixo') . '/painel/clientes/pessoafisica/visualizar'); ?>/' + responseR.cod_pessoa_crypt + '">';
                    conteudo_caixa_membro += '<i class="fa fa-search"></i> Ver';
                    conteudo_caixa_membro += '</a>';
                    conteudo_caixa_membro += '</div>';
                    conteudo_caixa_membro += '<div class="col-md-6 col-xs-12">';
                    conteudo_caixa_membro += '<a class="btn btn-block btn-danger btn_inativa_membro" href="<?php echo url(app('prefixo') . '/painel/contratos/pessoajuridica/remover-membro'); ?>/' + responseR.cod_membro_crypt + '">';
    ...
    /************************************
     #
     # Aplicando função no botão UTILIZAR COMO SUBSTITUTO DE MEMBRO
     # Abre modal para confirmar inclusão da pessoa como substituto de membro, além de definir serviços e vinculo
     # 
    *************************************/ 
    $(document).on('click', '.btn_trade_membro', function(e) {
        ...
        // Limpo todos os campos dentro da div
        limpar_campos_dentro_div('#modalConfirmaTradeMembro');
        ...
        // Guardo código do cliente no input hidden do modal
        $('#cod_pessoa_modal_2').val(codigo_da_pessoa);

        // Exibe modal para confirmar inclusão de membro
        $('#modalConfirmaTradeMembro').modal('toggle');
    ...
    /************************************
     #
     # Aplicando função no botão SUBSTITUIR MEMBRO
     # Busca no banco os dados da pessoa selecionada e cria uma DIV .caixa_membro para esta pessoa dentro da lista de membros
     # 
    *************************************/ 
    $(document).on('click', '.btn_confirmar_trade', function(e) {
        ...
        // Preparo informações para requisição
        var membro_antigo_modal = $(this).closest('#modalConfirmaTradeMembro').find('#membro_antigo_modal option:selected').val();
        var cod_pessoa_modal = $(this).closest('#modalConfirmaTradeMembro').find('#cod_pessoa_modal_2').val();
        var servicos_selecionados_modal = new Array; // Crio um array

        // Faço loop por possiveis checkboxes marcados
        $(this).closest('#modalConfirmaTradeMembro').find('input[name="servicos_membro_modal[]"]:checked').each(function() {
            servicos_selecionados_modal.push($(this).val());
        });
        ...
        // Checo se foi marcado um membro antigo para ser 'inativado'
        if (membro_antigo_modal == '') {

            // Coloco mensagem dentro da div de erros
            $('.msg_erro_modal').append('<h4 class="pt-0">Alerta</h4>');
            $('.msg_erro_modal').append('Antes de prosseguir, você deve selecionar o membro que será substituído.');
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo url(app('prefixo') . '/painel/contratos/pessoajuridica/substituir-membro-ajax'); ?>",
            data: { 
                "cod_contrato_pessoa_juridica_plano": '<?php echo Crypt::encrypt($contrato->cod_contrato_pessoa_juridica_plano); ?>',
                "membro_antigo": membro_antigo_modal,
                "cod_pessoa": cod_pessoa_modal,
                "servicos_selecionados": servicos_selecionados_modal
            },
            beforeSend: function() { 
            ...
            success: function(responseR) {
                ...
                if (responseR.status == 'erro') {
                    ...
                    // Remove a caixa do membro substituído
                    $('[data-codigo-pessoa="' + membro_antigo_modal + '"]').remove();
                    ...
                    $.toast({
                        heading: 'Sucesso',
                        text: 'Membro substituído com sucesso.',
                        showHideTransition: 'fade',
                        icon: 'success',
                        position: 'top-right',
                        hideAfter: false, // em milisegundos
    ...
    ***************************************************************************************/ 
    $(document).on('click', '.btn_atualizar_membros', function(e) {
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo url(app('prefixo') . '/painel/contratos/pessoajuridica/alterar-membros-ajax'); ?>",
            data: { 
