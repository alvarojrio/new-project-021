...
{!! Breadcrumbs::render('pessoa-juridica-contrato-cadastrar') !!}

<div class="page-title">
    <div class="title_left">
        <h3>Cadastrar Contrato para Pessoa Jurídica</h3>
    </div>
</div>
    ...
    <div class="col-xs-12">
        <div class="x_panel">
            <div class="x_content">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row hiddenrow_plano_1" style="display: none;">
                            ...
                            <div class="form-group col-md-4 col-xs-12">
                                ...
                                <input type="text" id="numero_contrato_pj" name="numero_contrato_pj" class="form-control input-sm" autocomplete="off" />
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12 col-xs-12">
                                ...
                                <select class="form-control input-sm" name="configuracao_taxa_consulta" id="configuracao_taxa_consulta">
                                    <option value="">Selecione</option>
                                    <option value="0">A empresa não irá cobrir</option>
                                    <option value="1">A empresa irá cobrir</option>
                                    <option value="2">Isenção total</option>
                                </select>
                ...
                <!-- ##################### INICIO CAIXA RESPONSÁVEL DO CONTRATO ##################### -->
                <div class="panel panel-default">
                    <div class="panel-heading clearfix">RESPONSÁVEL DO CONTRATO</div>
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12 col-xs-12">
                                ...
                                <div id="texto_sem_pessoas_empresa" class="text-danger" style="margin-bottom: 10px;">
                                NENHUMA EMPRESA FOI SELECIONADA COMO RESPONSÁVEL AINDA.
                                </div>
                                
                                <!-- DIV QUE ENGLOBA AS CAIXAS DE MEMBROS -->
                                <div id="espaco_caixa_membros_empresa" style="margin-bottom: 10px;">
                                    
                                    <!-- DIV ONDE SERÃO CARREGADAS DINAMICAMENTE AS CAIXAS DE MEMBROS -->
                                    <div class="row row_espaco_caixa_membros_empresa"></div>

                                </div>

                                <div class="clearfix"></div>

                                <!-- INICIO PANEL BUSCAR EMPRESAS -->
                                <div class="panel panel-info">
                                    <div class="panel-heading" data-toggle="collapse" href="#collapseEmpresa1">
                                        <span data-toggle="collapse" href="#collapseEmpresa1">Buscar Empresa <small>(Clique para expandir)</small></span>
                                        <span class="pull-right">
                                            <a data-toggle="collapse" href="#collapseEmpresa1">
                                                <i class="fas fa-chevron-down"></i>
                                            </a>
                                        </span>
                                    </div>

                                    <div id="collapseEmpresa1" class="panel-collapse collapse muda-collapse">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-xs-12">
                                                    ...
                                                    <a href="javascript:void(null);" class="btn btn-info pull-right btn_buscar_pj">
                                            ...
                                            <div class="panel panel-default panel-resultado-busca-pj" style="display: none;">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        <table class="minha_datatable_pj table table-striped table-hover table-bordered tabela_pj">
                                                        <thead>
                                                        <tr>
                                                            <th>CNPJ</th>
                                                            <th>Nome Fantasia</th>
                                ...
                                <!-- FIM PANEL BUSCAR EMPRESAS -->


                                <!-- INICIO PANEL CADASTRAR EMPRESA -->                                    
                                <!-- Inicio panel-info -->
                                <div class="panel panel-info panel_cadastrar_empresa">
                                    
                                    <div class="panel-heading" data-toggle="collapse" href="#collapseEmpresa2" data-target="#collapseEmpresa2">
                                        <span data-toggle="collapse" href="#collapseEmpresa2" data-target="#collapseEmpresa2">Cadastrar Empresa <small>(Clique para expandir)</small></span>
                                        <span class="pull-right">
                                            <a data-toggle="collapse" href="#collapseEmpresa2" data-target="#collapseEmpresa2">
                                                <i class="fas fa-chevron-down"></i>
                                            </a>
                                        </span>
                                    </div>
                                    ...
                                    <div id="collapseEmpresa2" class="panel-collapse collapse muda-collapse">
                                        <div class="panel-body">
                                            
                                            <!-- Renderizo View Component -->
                                            @render(drclub\Http\ViewComponents\CadastrarPessoaJuridicaComponent::class, 'cadastrarcontrato')
                ...
                <!-- ##################### FIM CAIXA RESPONSÁVEL DO CONTRATO ##################### -->
                
                
                <!-- ##################### INICIO CAIXA MEMBROS DO CONTRATO ##################### -->
                <div class="panel panel-default">
                    <div class="panel-heading clearfix">MEMBROS DO CONTRATO</div>
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12 col-xs-12">
                                ...
                                <div class="panel panel-info">
                                    <div class="panel-heading" data-toggle="collapse" href="#collapseFuncionario1">
                                        <span data-toggle="collapse" href="#collapseFuncionario1">Buscar Pessoa <small>(Clique para expandir)</small></span>
                                        <span class="pull-right">
                                            <a data-toggle="collapse" href="#collapseFuncionario1">
                                                <i class="fas fa-chevron-down"></i>
                                            </a>
                                        </span>
                                    </div>

                                    <div id="collapseFuncionario1" class="panel-collapse collapse muda-collapse">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <!-- INICIO CAIXA DE ALERTA DE ERRO -->
                                            <div class="box_alerta_erro_pf" style="display: none;">
                                            ...
                                            <div class="panel panel-default panel-resultado-busca-pf" style="display: none;">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        <table class="minha_datatable_pf table table-striped table-hover table-bordered tabela_pf">
                                                        <thead>
                                                        <tr>
                                                            <th>CPF</th>
                                                            <th>Nome</th>
                                ...
                                <div class="panel panel-info panel_cadastrar_pessoas">
                                    <div class="panel-heading" data-toggle="collapse" href="#collapseFuncionario2">
                                        <span data-toggle="collapse" href="#collapseFuncionario2">Cadastrar Pessoa <small>(Clique para expandir)</small></span>
                                        <span class="pull-right">
                                            <a data-toggle="collapse" href="#collapseFuncionario2">
                                                <i class="fas fa-chevron-down"></i>
                                            </a>
                                        </span>
                                    </div>
                                    
                                    <div id="collapseFuncionario2" class="panel-collapse collapse muda-collapse">
                                        <div class="panel-body">
                                            
                                            <!-- Renderizo View Component -->
                                            @render(drclub\Http\ViewComponents\CadastrarPessoaFisicaComponent::class, 'cadastrarcontratopj')
...
$(document).ready(function() {
    ...
    **********************************************/ 
    ...
    // Defino verificação de tecla apertada quando o foco estiver dentro de um input de busca de empresas. Caso a tecla apertada seja ENTER, executar ação padrão do botão '.btn_buscar_pj'
    $(document).on('keypress', '#cnpj_busca, #razao_social_busca, #nome_fantasia_busca', function(event) {
        ...
        if (valor_selecionado > 0) {
            ...
            if (auto_gestao === 1) {
                ...
                $.ajax({
                    cache: false,
                    type: 'POST',
                    url: "<?php echo url(app('prefixo') . '/painel/convenios/listar-planos-pj-convenio'); ?>",
    ...
    $(document).on('change', '#cod_plano', function() { 
        ...
        if (valor_selecionado > 0) {
            ...
            $.ajax({
                cache: false,
                type: 'POST',
                url: "<?php echo url(app('prefixo') . '/painel/planos/listar-servicos-plano-pj'); ?>",
    ...
    *************************************/ 
    ...
    // Aplicando função no botão Buscar RESPONSÁVEL DO CONTRATO PESSOA JURIDICA 
    // (usado em requisição ajax do CADASTRAR CONTRATO de PJ)
    $(document).on('click', '.btn_buscar_pj', function() {
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo url(app('prefixo') . '/painel/clientes/pessoajuridica/buscar-para-contrato'); ?>",
            data: { 
                ...
                if (response.status === 'erro') {
                    ...
                    tabela_pj = $('.minha_datatable_pj').DataTable({
                        ...
                        columns: [
                            ...
                            { "data": "btn_add_membro_empresa", "name": "btn_add_membro_empresa", "width": "7%", "searchable": false, "sortable": false }
                        ],
    ...
    // Aplicando função no evento KEYPRESS do botão Buscar RESPONSÁVEL DO CONTRATO PESSOA JURIDICA
    // (usado em requisição ajax do CADASTRAR CONTRATO de PJ)
    ...
    /************************************
     #
     # Aplicando função no botão ADICIONAR EMPRESA COMO MEMBRO RESPONSÁVEL DO CONTRATO
     # Busca no banco os dados da empresa selecionada e cria uma 
     # DIV .caixa_membro_responsavel para esta empresa dentro da lista de membros responsáveis do contrato
     # 
    *************************************/ 
    $(document).on('click', '.btn_add_membro_empresa', function(e) {
        ...
        // Recupero CODIGO DO CLIENTE PESSOA JURIDICA através de data-attribute no botão
        var codigo_pessoa_juridica = $(this).data('codigo-pessoa-juridica'); 
        
        // Checo se foi retornado / localizado um código de pessoa juridica
        if (codigo_pessoa_juridica === '') {

            // Mostra mensagem de erro
            $.toast({
                heading: 'Erro',
                text: 'Não foi possivel selecionar esta empresa como membro responsável do contrato. Aguarde alguns instantes e tente novamente ou atualize a página.',
                showHideTransition: 'fade',
                icon: 'error',
                position: 'top-right',
        ...
        var total_caixas_membros = $('#espaco_caixa_membros_empresa > .row').children().size(); 

        if (total_caixas_membros > 0) {

            // Mostra mensagem de erro
            $.toast({
                heading: 'Erro',
                text: 'Já existe uma empresa listada como membro responsável do contrato.',
                showHideTransition: 'fade',
                icon: 'error',
                position: 'top-right',
                hideAfter: 2000, // em milisegundos
        ...
        if ($('#espaco_caixa_membros_empresa > .row').children('div[data-codigo-pessoa-juridica="' + codigo_pessoa_juridica + '"]').length > 0) {  
            
            // Mostra mensagem de erro
            $.toast({
                heading: 'Erro',
                text: 'Esta empresa já foi inserida na lista como membro responsável do contrato.',
                showHideTransition: 'fade',
                icon: 'error',
                position: 'top-right',
                hideAfter: 2000, // em milisegundos
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo url(app('prefixo') . '/painel/clientes/pessoajuridica/buscar-por-codigo'); ?>",
            data: { 
                "codigo_pessoa_juridica": codigo_pessoa_juridica
            },
            beforeSend: function() { 
                // Nothing here
            },
            success: function(response) {
                ...
                if (response.status === 'erro') {
                    ...
                    var conteudo_caixa_membro_empresa = '';
                    
                    conteudo_caixa_membro_empresa += '<div class="col-md-4 col-sm-4 col-xs-12 caixa_membro_responsavel" data-codigo-pessoa-juridica="' + codigo_pessoa_juridica + '" style="display: none;">';
                    conteudo_caixa_membro_empresa += '<div class="x_panel tile" style="border-color: #73879C;">';
                    conteudo_caixa_membro_empresa += '<div class="row">';
                    conteudo_caixa_membro_empresa += '<div class="form-group">';
                    conteudo_caixa_membro_empresa += '<label class="control-label col-md-4 col-xs-12">CNPJ: </label>';
                    conteudo_caixa_membro_empresa += '<div class="col-md-8 col-xs-12">' + response.cnpj + '</div>';
                    conteudo_caixa_membro_empresa += '</div>';
                    conteudo_caixa_membro_empresa += '</div>';
                    conteudo_caixa_membro_empresa += '<div class="row">';
                    conteudo_caixa_membro_empresa += '<div class="form-group">';
                    conteudo_caixa_membro_empresa += '<label class="control-label col-md-4 col-xs-12">Razão Social: </label>';
                    conteudo_caixa_membro_empresa += '<div class="col-md-8 col-xs-12"><span class="membroempresa_nome">' + response.razao_social + '</span></div>';
                    conteudo_caixa_membro_empresa += '</div>';
                    conteudo_caixa_membro_empresa += '</div>';
                    conteudo_caixa_membro_empresa += '<div class="row">';
                    conteudo_caixa_membro_empresa += '<div class="form-group">';
                    conteudo_caixa_membro_empresa += '<label class="control-label col-md-4 col-xs-12">Nome Fantasia: </label>';
                    conteudo_caixa_membro_empresa += '<div class="col-md-8 col-xs-12">' + response.nome_fantasia + '</div>';
                    conteudo_caixa_membro_empresa += '</div>';
                    conteudo_caixa_membro_empresa += '</div>';                                      
                    conteudo_caixa_membro_empresa += '<a class="btn btn-sm btn-danger pull-right" id="btn_remove_membro_responsavel" style="margin-top: 5px;" href="javascript:void(null);">';
                    conteudo_caixa_membro_empresa += '<i class="fa fa-times-circle"></i> Remover';
                    conteudo_caixa_membro_empresa += '</a>';
                    conteudo_caixa_membro_empresa += '</div>';
                    conteudo_caixa_membro_empresa += '</div>';

                    // Oculta mensagem de lista de membros vazia
                    $('#texto_sem_pessoas_empresa').hide();

                    // Adiciona nova caixa de membro responsavel (e uma pequena animação de fade)
                    $(conteudo_caixa_membro_empresa).appendTo('.row_espaco_caixa_membros_empresa').fadeIn('slow');

                    // Rola a página até o elemento criado
                    $('html, body').animate({
                        scrollTop: $('#espaco_caixa_membros_empresa .caixa_membro_responsavel:last').offset().top
                    }, 50);
            ...
            error: function(response, thrownError) {
                ...
                $.toast({
                    heading: 'Erro',
                    text: 'Não foi possivel selecionar esta empresa como membro responsável do contrato.',
                    showHideTransition: 'fade',
                    icon: 'error',
                    position: 'top-right',
                    hideAfter: 2000, // em milisegundos
    ...
    /************************************
     #
     # Aplicando função no botão REMOVER MEMBRO RESPONSÁVEL DO CONTRATO
     # Remove DIV .caixa_membro_responsavel da lista de membros do contrato
     # 
    *************************************/ 
    $(document).on('click', '#btn_remove_membro_responsavel', function(e) {

        e.preventDefault(); 

        // Remove caixa de membro
        $(this).closest('.caixa_membro_responsavel').remove();
        ...
        if (total_caixas_membros < 1) {
            ...
            // Exibe mensagem de lista de membros responsaveis vazia
            $('#texto_sem_pessoas_empresa').show();
    ...
    /************************************
     #
     # Aplicando função no botão BUSCAR PESSOA MEMBROS DO CONTRATO
    ...
    *************************************/ 
    ...
    // Aplicando função no evento KEYPRESS do botão BUSCAR PESSOA MEMBROS DO CONTRATO
    ...
    /************************************
     #
     # Aplicando função no botão ADICIONAR PESSOA COMO MEMBRO DO CONTRATO
     # Busca no banco os dados da pessoa selecionada e cria uma 
     # DIV .caixa_membro para esta pessoa dentro da lista de membros
     # 
    *************************************/ 
    $(document).on('click', '.btn_add_membro', function(e) {
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo url(app('prefixo') . '/painel/clientes/pessoafisica/buscar-por-codigo2'); ?>",
            data: { 
            ...
            success: function(response) {
                ...
                if (response.status === 'erro') {
                    ...
                    // Conto o total atual de caixas de membros e usa como contador
                    var contador_combo = $('#espaco_caixa_membros > .row').children().size() + 1; 

                    // Preenchendo variável de conteúdo dinâmico
                    var conteudo_caixa_membro = '';
                    conteudo_caixa_membro += '<div class="col-md-4 col-sm-4 col-xs-12 caixa_membro" data-codigo-pessoa="' + codigo_pessoa + '" style="display: none;">'; //inicio caixa membro
                    ...
                    conteudo_caixa_membro += '</div>';
                    conteudo_caixa_membro += '</div>';  
                    conteudo_caixa_membro += '<br />';                   
                    
                    conteudo_caixa_membro += '<div class="row">';
                    conteudo_caixa_membro += '<div class="form-group">';                    
                    conteudo_caixa_membro += '<label class="control-label col-md-4 col-xs-12">Submembros: </label>';
                    conteudo_caixa_membro += '</div>';
                    conteudo_caixa_membro += '</div>';

                    conteudo_caixa_membro += '<div class="row">';
                    conteudo_caixa_membro += '<div class="col-md-12 col-xs-12">';
                    conteudo_caixa_membro += '<select class="form-control pessoas_submembro" name="submembros[]" id="submembros' + contador_combo + '" multiple>';
                    ...
                    conteudo_caixa_membro += '</div>';
                    conteudo_caixa_membro += '</div>'; //fim caixa membro
                    ...
                    // Cria variavel com nome dinâmico para guardar a referência do elemento
                    window['combo_submembro' + contador_combo] = $('#submembros' + contador_combo);

                    // Ativa o select multiple (com busca ajax)
                    window['combo_submembro' + contador_combo].select2({
                        language: "pt-BR",
                        ...
                        ajax: {
                            type: 'POST',
                            url: "<?php echo url(app('prefixo') . '/painel/clientes/pessoa/buscar-disponivel-para-contrato-por-nome'); ?>",
                            dataType: 'json',
                            delay: 250,
                            quietMillis: 250,
    ...
    /************************************
     #
     # Aplicando função no botão REMOVER MEMBRO DO CONTRATO
    ...
    *************************************/ 
    $(document).on('click', '#btn_salvar_contrato', function(e) {
        ...
        var data_cancelamento_contrato = $('#data_cancelamento_contrato').val();
        ...
        */
        ...
        var cod_pessoa_juridica = null;

        // Loop por todas as CAIXAS DE EMPRESAS
        $('.row_espaco_caixa_membros_empresa').children('.caixa_membro_responsavel').each(function(i, v) {

            // Capto o código da PJ e salvo em variavel
            cod_pessoa_juridica = $(v).data('codigo-pessoa-juridica'); // Recupero CODIGO DA PESSOA JURIDICA através de data-attribute na div
        ...
        var submembros_selecionados = new Array; // Crio um array  
        ...
        $('.row_espaco_caixa_membros').children('.caixa_membro').each(function(i, v) {
            ...
            // Faço loop por possiveis submembros selecionados            
            $(this).find('.pessoas_submembro > option:selected').each(function() {    
            
                submembros_selecionados.push($(this).val());
                
            });
            
            membros_filho['submembros_selecionados'] = (submembros_selecionados.length == 0) ? '' : submembros_selecionados; // Checo tamanho do array com o length

            // Faço loop por possiveis checkboxes de serviços marcados
            $(this).find('input[name="servicos_membro[]"]:checked').each(function() {
                servicos_selecionados.push($(this).val());
            });

            membros_filho['servicos_selecionados'] = (servicos_selecionados.length == 0) ? '' : servicos_selecionados; // Checo tamanho do array com o length
            ...
            membros_filho = {};
            submembros_selecionados = new Array;
        ...
        // Checo se a empresa que será responsável financeira foi definida
        if (cod_pessoa_juridica == '') {

            // Coloco mensagem dentro da div de erros e exibo a div de erros
            $('.msg_erro').append('<h4 class="pt-0">Alerta</h4>');
            $('.msg_erro').append('Antes de prosseguir, você precisa definir uma empresa para ser RESPONSÁVEL DO CONTRATO.');
            $('.msg_erro').show();
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo url(app('prefixo') . '/painel/contratos/pessoajuridica/cadastrar'); ?>",
            data: {                        
                ...
                "cod_pessoa_juridica": cod_pessoa_juridica
            },
            beforeSend: function() { 
