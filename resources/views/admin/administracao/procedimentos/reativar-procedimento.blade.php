    ...
    <div class="x_panel">
      <div class="x_content">
        <div class="row">
          ...
          <h4 class="text-info"><strong>Código:</strong> <?php echo $procedimento->codigo; ?></h4>
          <h4 class="text-info"><strong>Descrição:</strong> <span class="red"><?php echo mb_strtoupper($procedimento->descricao); ?></span></h4>

          <hr/>
          
          <form method="POST" action="<?php echo url('admin/painel/procedimentos/reativar-procedimento'); ?>" enctype="multipart/form-data">
            ...
            <div class="col--4 col-xs-12">
              ...
              <div class="form-group">
               ...
               <input type="hidden" id="codigo_procedimento_template" name="codigo_procedimento_template" value="<?php echo Crypt::encrypt($procedimento->cod_procedimento); ?>" />
