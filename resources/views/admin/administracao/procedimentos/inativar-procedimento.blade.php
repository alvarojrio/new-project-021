...
{!! Breadcrumbs::render('tabelas-inativar-procedimento', $tabela) !!}

<div class="page-title">
  <div class="title_left">
    <h3>Inativar Procedimento </h3>
  </div>
</div>
    ...
    <div class="x_panel">
      <div class="x_content">
        <div class="row">
          ...
          <h4 class="text-info"><strong>Nome do Procedimento:</strong> <?php echo mb_strtoupper($procedimento->descricao); ?></h4>
          ...
          <form method="POST" action="<?php echo url('admin/painel/procedimentos/inativar-procedimento'); ?>" enctype="multipart/form-data" id="form_salas">
