...
{!! Breadcrumbs::render('vendedores-cadastrar') !!}
...
<div class="row">
    <div class="col-xs-12">
      <div class="x_panel">
        <div class="x_content">
          <div class="row">
            <form action="<?php echo url('admin/painel/vendedores/cadastrar-vendedor'); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-xs-12">
                                ...
                                <select class="form-control" name="tipo_vendedor" id="tipo_vendedor" style="width:100%" required>
                                    ...
                                    <option value="">Selecione</option>
                                    <option value="1" <?php if (old('tipo_vendedor') == "1") { echo "checked";} ?> >Interno</option>
                                    <option value="2" <?php if (old('tipo_vendedor') == "2") { echo "checked";} ?> >Externo</option>
                                    <option value="3" <?php if (old('tipo_vendedor') == "3") { echo "checked";} ?> >Televendas</option>
                            ...
                            <div class="col-lg-3 col-xs-12">
                                ...
                                <select class="form-control" name="cobrador" id="cobrador" style="width:100%" required>
                                
                                    <option> Selecione </option>
                                    <option value="Nao" <?php if (old('tipo_vendedor') == "Nao") { echo "checked";} ?> >Não</option>
                                    <option value="Sim" <?php if (old('tipo_vendedor') == "Sim") { echo "checked";} ?> >Sim</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="radio" name="tipo_comissao" value="2" <?php if(old('tipo_comissao') == 2){ echo "checked"; }?>> Percentual (%)
