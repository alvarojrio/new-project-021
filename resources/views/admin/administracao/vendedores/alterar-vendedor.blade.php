...
{!! Breadcrumbs::render('vendedores-alterar') !!}
...
<div class="row">
    <div class="col-lg-12 col-md-12 col-xs-12">
      <div class="x_panel">
        <div class="x_content">
          <div class="row">
            <form action="<?php echo url('admin/painel/vendedores/alterar-vendedor'); ?>" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-lg-6 col-md-12 col-xs-12">
                <div class="panel panel-default">
                  <div class="panel-heading"><i class="fas fa-user"></i> Informações Básicas do Vendedor</div>
                        ...
                        <div class="form-group">
                          <div class="row">
                              ...
                              <div class="col-lg-4 col-md-12 col-xs-12 text-center foto_visivel visible">
                                  ...
                                  <div class="col-lg-12 col-md-12 col-xs-12">
                                    <img src="{{asset('uploads/pessoas/'.$vendedor->pessoa->foto)}}" alt="{{$vendedor->pessoa->foto}}" width="200px" height="200px" accesskey=""class="img-thumbnail">
                                  </div>
                                  
                                   <input type="hidden" name="foto_atual" id="foto_atual" value="{{$vendedor->pessoa->foto}}">
                                  <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <div class="col">
                              <div class="col-lg-8 col-md-12 col-xs-12">
                                <div class="form-group">
                                  ...
                                  <input type="text" autocomplete="off" class="form-control caixa_alta" name="nome" id="nome" placeholder="Nome" value="{{$vendedor->pessoa->nome}}" minlength="8" required>
                                </div>
                              </div>
                            </div>
                            <div class="col">
                                  <div class="col-lg-4 col-md-12 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <input type="text" autocomplete="off" class="form-control cpf" name="cpf" id="cpf" placeholder="000.000.000-00" value="{{ $vendedor->pessoa->cpf }}" minlength="14" onblur="return validaCampos()" required>
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-md-12 col-xs-12">
                                    <div class="form-group">
                                      <label class="control-label">Data de Nascimento</label>
                                      <input type="text" autocomplete="off" class="form-control" name="data_nascimento" id="data_nascimento"  placeholder="00/00/0000" value="<?php if($vendedor->pessoa->data_nascimento != ""){ echo date('d/m/Y', strtotime($vendedor->pessoa->data_nascimento)); }?>">
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-md-12 col-xs-12">
                                      <div class="form-group">
                                          <label class="control-label">Sexo</label>
                                            <select class="form-control" name="sexo" id="sexo">
                                                ...
                                                <option value="2" <?php if ($vendedor->pessoa->sexo == 2) { echo "selected";} ?>>Feminino</option>
                                                <option value="1" <?php if ($vendedor->pessoa->sexo == 1) { echo "selected";} ?>>Masculino</option>
                                           </select>
                                      </div>
                                  </div>
                                  <div class="col-lg-4 col-md-12 col-xs-12">
                                      <div class="form-group">
                                        <label class="control-label">Estado Civil</label>
                                            <select class="form-control" name="estado_civil" id="estado_civil">
                                                <option value="">Selecione</option>
                                                <option value="2" <?php if ($vendedor->pessoa->estado_civil == 2) { echo "selected";} ?>>Casado (a)</option>
                                                <option value="4" <?php if ($vendedor->pessoa->estado_civil == 4) { echo "selected";} ?>>Divorciado (a)</option>
                                                <option value="1" <?php if ($vendedor->pessoa->estado_civil == 1) { echo "selected";} ?>>Solteiro (a)</option>
                                                <option value="3" <?php if ($vendedor->pessoa->estado_civil == 3) { echo "selected";} ?>>Viúvo (a)</option>
                                            </select>
                                      </div>
                                  </div>
              ...
              <div class="col-lg-6 col-md-12  col-xs-12">
                <div class="panel panel-default">
                  <div class="panel-heading"><i class="fas fa-user"></i> Contatos do Vendedor</div>
                  <div class="panel-body">   
                    <div class="row">
                      <div class="col-lg-12 col-md-12 col-xs-12">
                        <div class="form-group">
                          <label class="control-label">E-mail</label>
                          <input type="email" autocomplete="off" class="form-control caixa_baixa" name="email" id="email" placeholder="exemplo@exemplo.com" value="<?php echo $vendedor->usuarios->email; ?>">
                        </div>
                      </div>                          
                    </div>  
                  <div class="row">
                    <div class="col-lg-6 col-md-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="tel" autocomplete="off" class="form-control telefone" name="telefone" id="telefone" placeholder="(00) 0000-0000" value="<?php echo $vendedor->pessoa->telefone; ?>">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-xs-12">
                        <div class="form-group">
                            <label class="control-label">Celular</label>
                            <input type="tel" autocomplete="off" class="form-control celular" name="celular" id="celular" placeholder="(00) 0000-0000" value="<?php echo $vendedor->pessoa->celular; ?>">
                        </div>
                    </div>
                  </div>  
                    <div class="row">
                      <div class="col-lg-6 col-md-12 col-xs-12">
                        <div class="form-group">
                          ...
                          <input type="text" autocomplete="off" class="form-control cep" name="cep" id="cep" placeholder="00000-000" onblur="puxaEndereco()" <?php if (!empty(old('cep'))) { ?> value="<?php echo old('cep'); ?>" <?php }else{?> value ="<?php echo $vendedor->pessoa->cep; ?>"<?php } ?> minlength="9">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-6 col-md-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="cod_estado" id="cod_estado" onchange="buscarCidades()">
                               <option value="">Selecione..</option>
                               <?php  if($vendedor->pessoa->cod_cidade != 0){ ?>

                                    <?php foreach($estados as $estado): ?>
                                    
                                        <option value="<?php echo $estado->cod_estado; ?>" <?php if($vendedor->pessoa->cidades->estados->cod_estado == $estado->cod_estado){ echo "selected='selected'"; } ?> ><?php echo $estado->nome_estado; ?></option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 col-xs-12">
                            <div class="form-group">
                              ...
                              <input type="text" autocomplete="off" class="form-control" name="bairro" id="bairro" placeholder="Bairro" value="{{ $vendedor->pessoa->bairro }}">
                            </div>
                        </div>
                    </div>  
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            <div class="form-group">
                              ...
                              <input type="text" autocomplete="off" class="form-control" name="logradouro" id="logradouro" placeholder="Logradouro" value="{{$vendedor->pessoa->logradouro}}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">  
                        <div class="col-lg-6 col-md-12 col-xs-12">
                            <div class="form-group">
                              ...
                              <input type="text" autocomplete="off" class="form-control" name="complemento" id="complemento" placeholder="Complemento" value="{{$vendedor->pessoa->complemento}}">
                            </div>
                        </div>    
                        ...
                        <div class="col-lg-6 col-md-12 col-xs-12">
                            <div class="form-group">
                              ...
                              <input type="text" autocomplete="off" class="form-control" name="numero" id="numero" placeholder="Número do edifício" value="{{$vendedor->pessoa->numero}}" onkeypress="return event.charCode >= 48" min="1">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-5 col-md-12 col-xs-12">  
                                ...
                                <select class="form-control" name="unidades[]" id="unidades" multiple required>
                                    ...
                                    <option value="<?php echo $unidade->cod_unidade; ?>" <?php if (in_array($unidade->cod_unidade, $vendedor->unidades()->where('funcionarios_unidades.status',1)->pluck('funcionarios_unidades.cod_unidade')->toArray())) { echo "selected"; } ?>><?php echo $unidade->nome_unidade; ?></option>
                            ...
                            <div class="col-lg-3 col-xs-12">
                                ...
                                <label class="control-label">Tipo de vendedor <span class="required-red">*</span></label>
                                
                                <select class="form-control" name="tipo_vendedor" id="tipo_vendedor" style="width:100%" required="">
                                
                                    <option value="0">Selecione</option>
                                    <option value="1" <?php if($vendedor->tipo_vendedor == 1){echo 'selected';} ?>>Interno</option>
                                    <option value="2" <?php if($vendedor->tipo_vendedor == 2){echo 'selected';} ?>>Externo</option>
                                    <option value="3" <?php if($vendedor->tipo_vendedor == 3){echo 'selected';} ?>>Televendas</option>
                            ...
                            <div class="col-lg-4 col-md-12 col-xs-12">  
                                ...
                                <select class="form-control" name="" id="">
                                    <option>Não</option>
                                    <option value='1' <?php if($vendedor->cobrador == 1){echo 'selected';} ?> >Sim</option>
                                </select>
                            </div>
                    ...
                    <div class="row">  
                        <div class="col-lg-6 col-xs-12">    
                           <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" class="form-control" name="usuario" id="usuario" placeholder="Usuário de login" value="{{$vendedor->usuarios->usuario}}"  required>
                           </div>
                        </div>
              ...
              <div class="col-xs-12">
                <input type="hidden" id="cod_pessoa" name="cod_pessoa" value="{{Crypt::encrypt($vendedor->cod_pessoa)}}" />  
...
// Verificando se havia um cep antes.. 
<?php if(!empty($vendedor->pessoa->cep)) { ?> 
    // Chamo a função ..
    puxaEndereco();
    
<?php }elseif(empty($vendedor->pessoa->cep)){ ?> 
    
    // Chamo a função caso tenha um id de estado  
    <?php if($vendedor->pessoa->cod_cidade > 0){ ?>

          buscarCidades("{{ $vendedor->pessoa->cidades->estados->cod_estado }}","{{ $vendedor->pessoa->cidades->cod_cidade }}");
