...
{!! Breadcrumbs::render('conciliacao-remover-membro-contrato', $contrato) !!}
    ...
    <div class="col-xs-12">
        <div class="x_panel">
            <div class="x_content">
                ...
                <form id="frm_remover_membro" method="post" action="<?php echo url('admin/painel/conciliacaovendas/remover-membro-contrato-pf'); ?>">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12 col-xs-12">
                        ...
                        <!-- BOTÃO RETORNAR -->
                        <a class="btn btn-md btn-danger" id="btn_retornar" href="<?php echo url('admin/painel/conciliacaovendas/gerenciar-membros-contrato-pf/' . Crypt::encrypt($contrato->cod_contrato_pessoa_fisica_plano)); ?>">
