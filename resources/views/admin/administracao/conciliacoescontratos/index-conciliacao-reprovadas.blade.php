...
{!! Breadcrumbs::render('conciliacao-vendas-reprovadas') !!}
	...
	<div class="col-xs-12">
		<div class="x_panel">
			<div class="x_content">
				...
				<h2 class="text-danger">Lista de Conciliações Reprovadas</h2>
...
$(document).ready(function() {
    ...
    var tabela = $('.minha_datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
            "url": "<?php echo url('admin/painel/conciliacaovendas/datatable-contratos-reprovados'); ?>",
            "type": "POST"
        },
        stateSave: false,
        deferRender: false,
