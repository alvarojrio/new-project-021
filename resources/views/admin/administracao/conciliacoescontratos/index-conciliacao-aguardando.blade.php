...
{!! Breadcrumbs::render('conciliacao-vendas') !!}
	...
	<div class="col-xs-12">
		<div class="x_panel">
			<div class="x_content">
                ...
                <div class="row tile_count">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count text-center">
                        ...
                        <span class="count_bottom">
                            ...
                            <a class="btn btn-sm btn-info" href="<?php echo url('admin/painel/conciliacaovendas/index-aprovadas'); ?>">
                            <i class="fa fa-search"></i> Visualizar Conciliações
                            </a>
				...
				<h2 class="text-warning">Lista de Conciliações Aguardando</h2>
...
$(document).ready(function() {
    ...
    var tabela = $('.minha_datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
            "url": "<?php echo url('admin/painel/conciliacaovendas/datatable-contratos-aguardando'); ?>",
            "type": "POST"
        },
        stateSave: false,
        deferRender: false,
        ...
        columns: [
            ...
            { "data": 7, "name": "tempo", "width": "10%", "searchable": false, "sortable": false },
            { "data": 8, "name": "ver", "width": "2%", "searchable": false, "sortable": false },
            { "data": 9, "name": "conciliar", "width": "2%", "searchable": false, "sortable": false }
        ],
