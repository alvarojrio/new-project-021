    ...
    <div class="col-xs-12">
        <div class="x_panel">
            <div class="x_content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-xs-12 text-center" style="margin-top: 7px; margin-bottom: 7px;">
                        ...
                        <div class="box_alerta_amarelo">
                            ...
                            <h4 style="margin: 0 auto; margin-top: 0px;">Este cadastro estará em pré-ativação</h4>
                                ...
                                <div class="panel panel-info panel_cadastrar_pessoas">
                                    ...
                                    <div id="collapse2" class="panel-collapse collapse muda-collapse">
                                        <div class="panel-body">
                                            ...
                                            @render(drclub\Http\ViewComponents\CadastrarConciliacaoPessoaFisicaComponent::class, 'cadastrarcontrato')
                ...
                <!-- BOTÃO PARA VOLTAR -->
                <a href="<?php echo url('admin/painel/clientes'); ?>" class="btn btn-default pull-right">
        ...
        if (valor_selecionado > 0) {
            ...
            if (auto_gestao == 1) {
                ...
                $.ajax({
                    cache: false,
                    type: 'POST',
                    url: "<?php echo url('admin/painel/convenios/listar-planos-convenio'); ?>",
    ...
    $(document).on('change', '#cod_plano', function() { 
        ...
        if (valor_selecionado > 0) {
            ...
            $.ajax({
                cache: false,
                type: 'POST',
                url: "<?php echo url('admin/painel/planos/listar-servicos-plano'); ?>",
    ...
    *************************************/ 
    $(document).on('click', '.btn_buscar_pf', function(event) {
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo url('admin/painel/clientes/buscar-pessoa-fisica-para-contrato'); ?>",
            data: { 
                "cpf_busca": cpf_busca,
    ...
    *************************************/ 
    $(document).on('click', '.btn_add_membro', function(e) {
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo url('admin/painel/clientes/buscar-cliente-por-codigo'); ?>",
            data: { 
    ...
    $(document).on('click', '#btn_salvar_contrato', function(e) {
        ...
        */
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo url('admin/painel/conciliacaovendas/cadastrar-contrato-pf'); ?>",
            data: { 
                ...
                if (response.status == 'erro') {
                    ...
                    $.toast({
                        ...
                        afterHidden: function() { // Evento após o alert desaparecer
                            ...
                            // Redireciona
                            window.location.replace("<?php echo url('admin/painel/conciliacaovendas/visualizar-contrato-pf'); ?>/" + response.cod_contrato);
