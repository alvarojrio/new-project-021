...
{!! Breadcrumbs::render('conciliacao-contrato-editar', $contrato) !!}
            ...
            <div class="x_content">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <!-- INICIO LINHA -->
                        <div class="row hiddenrow_plano_2" style="display: block;">
    ...
    $(document).on('click', '#btn_atualizar_contrato', function(e) {
        ...
        */
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo url('admin/painel/conciliacaovendas/editar-contrato-pf'); ?>",
            data: { 
            ...
            success: function(response) {
                ...
                if (response.status == 'erro') {
                    ...
                    if (response.redirecionar_para == 'visualizarcontrato') {
                        ...
                        // Redireciona
                        window.location.replace("<?php echo url('admin/painel/conciliacaovendas/gerenciar-membros-contrato-pf'); ?>/" + response.cod_contrato);
