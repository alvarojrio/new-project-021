...
<div class="row">
	<div class="col-xs-12">
		<div class="x_panel">
			<div class="x_content">
				<div class="row">
					<form method="POST" action="<?php echo url('admin/painel/feriados/cadastrar');?>">
						...
						<div class="col-xs-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="descricao" id="descricao" placeholder="Descrição do Feriado" value="{{ old('descricao') }}" required>
							</div>
							<div class="form-group">
								<label class="control-label">Data <span class="required-red">*</span></label>
								<input type="text" class="form-control datepicker" name="data" id="data" placeholder="Data do Feriado" value="{{ old('data') }}" required>
							</div>
						</div>
						<div class="col-xs-12">
