...
<a class="btn btn-md <?php if ($origem == 'subpagina') { ?>btn-primary<?php } else { ?>btn-success<?php } ?> pull-right" id="btn_salvar" href="javascript:void(null);" role="button">
    ...
    ************************************************/ 
    $(document).on('click', '.btn_salvar_imagem', function(e) {
        ...
        $.ajax({
            ...
            processData: false,
            type: "POST",
            url: "<?php echo url('admin/painel/clientes/foto-pf-upload'); ?>",
            data: form_data,
            beforeSend: function() { 
    ...
    ************************************************/ 
    $(document).on('click', '.btn_salvar_documento', function(e) {
        ...
        $.ajax({
            ...
            processData: false,
            type: "POST",
            url: "<?php echo url('admin/painel/conciliacaovendas/documento-pf-upload'); ?>",
            data: form_data,
            beforeSend: function() { 
    ...
    ***************************************************************/ 
    $(document).on('blur', '.cpf', function() { 
        ...
        $.ajax({
            cache: false,
            type: 'POST',
            url: "<?php echo url('admin/painel/conciliacaovendas/buscar-pessoa-fisica-por-cpf'); ?>",
            data: { 
    ...
    $(document).on('click', '#btn_salvar', function(e) {
        ...
        $('div#caixas_de_pessoas > div.panel_pessoa').each(function() {
            ...
            *************************************/
            ...
            pessoas_filho['parentesco'] = ($('#parentesco', this).val() == null) ? '' : $('#parentesco', this).val();
            /************************************
              ::: ENDEREÇO :::
            *************************************/
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo url('admin/painel/conciliacaovendas/cadastrar-pessoa-fisica'); ?>",
            data: { 
                                ...
                                success: function(responseR) {
                                    ...
                                    if (responseR.status == 'erro') {
                                        ...
                                        *******************************************************************/
                                        ...
                                        conteudo_cx_membro += '<a class="btn btn-block btn-default btn_ver_membro" href="<?php echo url('admin/painel/clientes/visualizar-pessoa-fisica'); ?>/' + responseR.cod_pessoa_crypt + '">';
                                        conteudo_cx_membro += '<i class="fa fa-search"></i> Ver';
                                        conteudo_cx_membro += '</a>';
                                        conteudo_cx_membro += '</div>';
                                        conteudo_cx_membro += '<div class="col-md-6 col-xs-12">';
                                        conteudo_cx_membro += '<a class="btn btn-block btn-danger btn_inativa_membro" href="<?php echo url('admin/painel/contratos/remover-membro-contrato-pf'); ?>/' + responseR.cod_membro_crypt + '">';
                    ...
                    ?>
                        ...
                        $.toast({
                            ...
                            afterHidden: function() { // Evento após o alert desaparecer
                                ...
                                // Redireciono
                                window.location.replace("<?php echo url('admin/painel/conciliacaovendas'); ?>");
...
$(document).on('click', '.btn_salvar_foto', function() {
    ...
    if (origem_camera == 'foto_pessoa') {
        ...
        Webcam.snap(function(data_uri) {
            ...
            $.ajax({
                url: "<?php echo url('admin/painel/conciliacaovendas/foto-pf-webcam'); ?>",
...
$(document).on('click', '.btn_salvar_foto_documento', function() {
    ...
    if (origem_camera == 'foto_documento') {
        ...
        Webcam.snap(function(data_uri) {
            ...
            $.ajax({
                url: "<?php echo url('admin/painel/conciliacaovendas/foto-documento-pf-webcam'); ?>",
