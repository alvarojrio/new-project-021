    ...
    <div class="col-md-8">
      <div class="panel panel-info">
        ...
        <div class="panel-body">
          ...
          <button id="enviar" type="submit" tabindex="1" class="btn btn-primary" onclick="javascript: window.location.replace('<?php echo URL::to('admin/painel/conciliacaovendas/'); ?>');">
