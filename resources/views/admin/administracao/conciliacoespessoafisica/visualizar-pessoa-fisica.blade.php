...
{!! Breadcrumbs::render('conciliacao-pf-visualizar') !!}
                            ...
                            <div id="aba_1" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        ...
                                        <!-- INICIO PANEL -->
                                        <div class="panel panel-info subpanel_pessoa" style="min-height: 609px;">
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        ...
                                        <!-- INICIO PANEL -->
                                        <div class="panel panel-info subpanel_pessoa_b">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 col-xs-12">
                                                        ...
                                                        @if (count($arquivo_cliente->arquivos_clientes))
                                                            ...
                                                            <tbody>
                                                                @foreach ($arquivo_cliente->arquivos_clientes as $arquivo)
                                                                <tr>
                                                                    <td>{{ $arquivo->arquivo }}</td>
                                                                    <td>{{ $arquivo->descricao_arquivo }}</td>
                                                                    <td class="text-center"><a href="{{ url('admin/painel/clientes/download-arquivo-pessoa-fisica/' . Crypt::encrypt($arquivo->cod_arquivo_cliente)) }}" target="_blank" class="btn btn-primary btn-sm"><i class="fas fa-cloud-download-alt"></i></a></td>
                                                                </tr>
                                                                @endforeach
                                                            </tbody>
                                                            </table>
                                        ...
                                        ?>
                                            ...
                                            @foreach ($contrato_pfs as $contrato_pf)
                								...
                								<tr <?php if ($eh_contrato_ativo == 1 and $eh_membro_ativo == 1) { ?>class="success"<?php } ?>>        
                                                    ...
                                                    <td>
                                                        <a class="btn btn-sm btn-default" data-tooltip="tooltip" title="Visualizar Contrato" href="<?php echo url('admin/painel/conciliacaovendas/visualizar-contrato-pf/' .  Crypt::encrypt($contrato_pf->cod_contrato_pessoa_fisica_plano)); ?>">
                                        ...
                                        ?>
                                            ...
                                            @foreach ($contrato_pjs as $contrato_pj)
                                                ...
                                                <tr <?php if ($eh_contrato_ativo == 1 and $eh_membro_ativo == 1) { ?>class="success"<?php } ?>>        
                                                    ...
                                                    <td>
                                                        <a class="btn btn-sm btn-default" data-tooltip="tooltip" title="Visualizar Contrato" href="<?php echo url('admin/painel/conciliacaovendas/visualizar-contrato-pj/' .  Crypt::encrypt($contrato_pj->cod_contrato_pessoa_juridica_plano)); ?>">
                                                            <i class="fas fa-search"></i>
                                                        </a>
                                                    </td>                                                                            
                                                </tr>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.btn_buscar_lt', function(event) {
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo url('admin/painel/conciliacaovendas/buscar-linha-tempo'); ?>",
            data: { 
    ...
    $(document).on('click', '.btn_resetar_lt', function(event) {
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url: "<?php echo url('admin/painel/conciliacaovendas/resetar-linha-tempo'); ?>",
            data: { 
                "cod_cliente": "<?php echo Crypt::encrypt($cliente->cod_cliente); ?>"
            },
            beforeSend: function() {
