                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                 ...
                                 <div class="form-group">
                                     ...
                                     <input type="text" class="form-control caixa_alta" name="nome_sala_espera" id="nome_sala_espera" placeholder="Nome da sala de espera" <?php if (!empty(old('nome_sala_espera'))) { ?>value="<?php echo old('nome_sala_espera'); ?>"<?php } ?> minlength="4" autofocus="off" autocomplete="off" required="required">
                                 </div>
                                     ...
                                     <select class="form-control" name="btn_unidade" id="btn_unidade" required="required">
                                        ...
                                        <?php 
                                           foreach ($unidades as $u):
                                              ...
                                              ?> <option value="<?php echo Crypt::encrypt($u->cod_unidade); ?>"><?php echo $u->nome_unidade; ?></option><?php
