    ...
    <div class="modal-content">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
       ...
       <div class="form-group">
           ...
           <input type="text" class="form-control currency" name="nome" id="valor" required="required">
       </div>
  ...
  <!-- FIM DA COLUNA -->   <!-- INICIO DA COLUNA -->
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
       ...
       <div class="form-group">
           ...
           <input type="text" class="form-control" name="iniciar_quando" id="iniciar_quando" required="required">
       </div>
...
function salvarTicket(){
      ...
      var iniciar_quando = $("#iniciar_quando").val();
