   ...
   <div class="col-xs-12">
      ...
      <div class="x_panel">
         ...
         <div class="x_content">
                   ...
                   <button class="btn btn-success pull-left" onclick="abrirModal()" id="bnt_abrir_modal"><i class="far fa-save"></i> CADASTRAR INGRESSO</button>
...
<div class="modal" tabindex="-1" role="dialog" id="meuModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form name="reset-form" id="resetform">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
       ...
       <div class="form-group">
           <label class="control-label"> Preço  <span class="required-red">*</span></label>
           <input type="text" class="form-control currency" name="valor" id="valor" required="required">
       </div>

      </div>
      <!-- FIM DA COLUNA -->   <!-- INICIO DA COLUNA -->
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">

       <div class="form-group">
           <label class="control-label"> Quantidade  <span class="required-red">*</span></label>
           <input type="text" class="form-control" name="quantidade" id="quantidade" required="required">
       </div>
  ...
  <!-- FIM DA COLUNA -->   <!-- INICIO DA COLUNA -->
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
       ...
       <div class="form-group">
           <label class="control-label"> Ínicia as vendas quando  <span class="required-red">*</span></label>
           <select class="form-control" id="trocar_html" onchange="trocarhtml()">
             <option value="1">Data e Hora</option>
             <option value="2">Quando terminam as venda para:</option>
           </select>
       </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 inicio-produto-html" style="display:none">

       <div class="form-group">
           <label class="control-label"> Selecione o ingresso <span class="required-red">*</span></label>
         
           <select class="form-control" name="produtos_inicio" id="produtos_inicio">
           </select>
    ...
    <!-- INICIO DA COLUNA -->
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 inicio-html">
    ...
    <!-- INICIO DA COLUNA -->
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                 ...
                                 <div class="form-group">
                                     ...
                                     placeholder="Horario"  value="" autofocus="off" autocomplete="off" required="required">
