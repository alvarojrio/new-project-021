...
<html lang="pt-br">
  <head>
    ...
    <meta name="dcterms.rights" content="(c) <?php echo e(date('Y')); ?> CMRJ" /> 
    ...
    <link href="<?php echo e(asset('plugins/nprogress/nprogress.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('plugins/animate.css/animate.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/admin/login/login-admin.css')); ?>" rel="stylesheet">
        ...
        <div class="animate form login_form">
          <section class="login_content">
            ...
            <form method="post" action="<?php echo route('admin-logar'); ?>">
              ...
              <div>
                <input type="text" class="form-control" name="usuario" id="usuario" placeholder="Usuário" value="<?php echo e(old('usuario')); ?>" autocomplete="off" required />
              </div>

              <div>
                <input type="password" class="form-control" name="senha" id="senha" placeholder="Senha" value="<?php echo e(old('senha')); ?>" required />
              </div>
              ...
              <div class="separator">
                <div>
                  ...
                  <p style="font-size: 11px;">© <?php echo e(date('Y')); ?> Todos direitos reservados - LANCHAS</p>
                </div>
              </div>
...
<?php /**PATH C:\xampp\htdocs\new-project-021\resources\views/admin/login/index.blade.php ENDPATH**/ ?>