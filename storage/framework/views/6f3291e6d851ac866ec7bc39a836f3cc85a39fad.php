      ...
      <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="form-group">
                    ...
                    <input name="telefone2" type="text" class="form-control" id="telefone2" maxlength="15" required="" >
...
"  id="cep"  value="" required="">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input name="endereco" type="text"  class="form-control text-uppercase" id="rua"   required="">
         ...
         <div class="row">    
            ...
            <div class="col-md-2">
                ...
                <div class="form-group">
                    ...
                    <input name="complemento" type="text" class="form-control text-uppercase" id="complemento" >
            ...
            <div class="col-md-3">
                ...
                <div class="form-group">
                    ...
                    <input name="bairro" type="text" class="form-control text-uppercase" id="bairro"   required="">
            ...
            <div class="col-md-5">
                ...
                <div class="form-group">
                    ...
                    <input name="cidade" type="text" class="form-control text-uppercase" id="cidade"   required="">
                        ...
                        <select name="uf" id="uf" class="form-control">
                            ...
                            <div class="row" id="credito">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-heading"><i class="far fa-credit-card"></i> Dados de acesso</div>
                                    <!-- INICIO PANEL-BODY -->							
