...
<link rel="shortcut icon"
        ...
        <script type="text/javascript" src="<?php echo e(PagSeguro::getUrl()['javascript']); ?>"></script>

       


<link href="<?php echo e(asset('site/css/chekout-estilo.css')); ?>" rel="stylesheet">
<link href="<?php echo e(asset('card/card.css')); ?>" rel="stylesheet">
<style type="text/css">
...
<?=substr($dados['hora_fim'], 0, 5)?> 
            ...
            <div class="col-md-4">
                <img src="<?php echo e(asset('site/img/logo-mini.jpg')); ?>" class="img-fluid" alt="Villa Mix BH">
            </div>
        </section>
            ...
            <div class="col-md-12 view-cielo">
                ...
                <div class="card ">
                    <div class="card-header">
                       ...
                       <?php echo $__env->make('site.cielo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="col-md-12 view-pagseguro" style="display:none">
                ...
                <div class="card">
                    <div class="card-header">
                       ...
                       <?php echo $__env->make('site.pagseguro', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
?>      
    ...
    <footer class="p-3 mt-5 cor-fundo">
     ...
     <input type="hidden" id="valor_total_checkout" value="<?=$valor_total?>">
        ...
        <script type="text/javascript" src="<?php echo e(asset('card/payment.min.js')); ?>"></script> 
        <script type="text/javascript" src="<?php echo e(asset('card/card.js')); ?>"></script> 
                    ...
                    success: function(response1) {
                        ...
                        $.each(response1.installments[response.brand.name], function(key, value){
                            $('select[name=pagseguroParcelas]').append('<option value="'+value.quantity+'x'+value.installmentAmount.toFixed(2)+'">'+value.quantity+' vezes R$: '+value.installmentAmount.toFixed(2).replace('.', ',')+' (Total: '+value.totalAmount.toFixed(2).replace('.', ',')+') - ' + response.brand.name.toUpperCase() + '</option>');
                             // console.log('<option value="'+value.quantity+'x'+value.installmentAmount.toFixed(2)+'">'+value.quantity+' vezes <?php echo e(('currency_symbol')); ?> '+value.installmentAmount.toFixed(2).replace('.', ',')+' (Total: '+value.totalAmount.toFixed(2).replace('.', ',')+') - ' + response.brand.name.toUpperCase() + '</option>');
                        });
