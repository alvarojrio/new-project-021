...
class PagSeguroConfig
{
    ...
    {
        $this->sandbox = true;//config('pagseguro.sandbox', env('PAGSEGURO_SANDBOX', true));
        $this->email = 'alvarodejunior@gmail.com';//config('pagseguro.email', env('PAGSEGURO_EMAIL', ''));
        $this->token = '57A35C7D5F364AAD9D717EF87A8BDD5B';//config('pagseguro.token', env('PAGSEGURO_TOKEN', ''));
        $this->notificationURL = 'https://grupo021.com.br/021/php/notificacoes.php'; //config('pagseguro.notificationURL', env('PAGSEGURO_NOTIFICATION', ''));
    }
